...
type callbackInvoker func(argvals /* **C.uchar*/ unsafe.Pointer, sigobj interface{})
...
*/
func callbackInvoke(f interface{}, argvalsp /* **C.uchar*/ unsafe.Pointer, sigobj interface{}) {
