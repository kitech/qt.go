...
func (this *QSGRectangleNode) Rect() *qtcore.QRectF /*123*/ {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZNK16QSGRectangleNode4rectEv", ffiqt.FFI_TYPE_POINTER, mv, this.GetCthis())
	gopp.ErrPrint(err, rv)
	//  return rv
...
func (this *QSGRectangleNode) Color() *qtgui.QColor /*123*/ {
	mv := qtrt.Calloc(1, 256)
	rv, err := ffiqt.InvokeQtFunc6("_ZNK16QSGRectangleNode5colorEv", ffiqt.FFI_TYPE_POINTER, mv, this.GetCthis())
	gopp.ErrPrint(err, rv)
	//  return rv
	rv = uint64(uintptr(mv))
