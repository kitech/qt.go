...
const (
	...
	// this const declaration states. However  since Qt::AlignBaseline is only used by layouts
	// it doesn't make sense to pass Qt::AlignBaseline to QPainter::drawText()  so there
	// shouldn't really be any ambiguity between the two overlapping const values.
