 ...
 */
func (this *QAbstractConcatenable) ConvertFromAscii(a string, len_ int, out_ QChar_ITF) {
	var convArg0 = qtrt.CString(a)
	defer qtrt.FreeMem(convArg0)
	var convArg2 unsafe.Pointer
	if out_ != nil && out_.QChar_PTR() != nil {
		convArg2 = out_.QChar_PTR().GetCthis()
	}
...
func QAbstractConcatenable_ConvertFromAscii(a string, len_ int, out_ QChar_ITF) {
	var nilthis *QAbstractConcatenable
	nilthis.ConvertFromAscii(a, len_, out_)
}
 ...
 */
func (this *QAbstractConcatenable) AppendLatin1To(a string, len_ int, out_ QChar_ITF /*777 QChar **/) {
	var convArg0 = qtrt.CString(a)
	defer qtrt.FreeMem(convArg0)
	var convArg2 unsafe.Pointer
	if out_ != nil && out_.QChar_PTR() != nil {
...
func QAbstractConcatenable_AppendLatin1To(a string, len_ int, out_ QChar_ITF /*777 QChar **/) {
	var nilthis *QAbstractConcatenable
	nilthis.AppendLatin1To(a, len_, out_)
}
