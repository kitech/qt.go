...
// index:0
// Public static
// bool startTcpDebugServer(int, enum QQmlDebuggingEnabler::StartMode, const QString &)
...
// index:0
// Public static
// bool connectToLocalDebugger(const QString &, enum QQmlDebuggingEnabler::StartMode)
