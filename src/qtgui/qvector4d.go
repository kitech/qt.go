...
func (this *QVector4D) IsNull() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK9QVector4D6isNullEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QVector4D) X() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK9QVector4D1xEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QVector4D) Y() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK9QVector4D1yEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QVector4D) Z() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK9QVector4D1zEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QVector4D) W() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK9QVector4D1wEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QVector4D) SetX(x float32) {
	// 0: (, x float), (&x)
	rv, err := ffiqt.InvokeQtFunc6("_ZN9QVector4D4setXEf", ffiqt.FFI_TYPE_VOID, this.GetCthis(), &x)
	gopp.ErrPrint(err, rv)
}
...
func (this *QVector4D) SetY(y float32) {
	// 0: (, y float), (&y)
	rv, err := ffiqt.InvokeQtFunc6("_ZN9QVector4D4setYEf", ffiqt.FFI_TYPE_VOID, this.GetCthis(), &y)
	gopp.ErrPrint(err, rv)
}
...
func (this *QVector4D) SetZ(z float32) {
	// 0: (, z float), (&z)
	rv, err := ffiqt.InvokeQtFunc6("_ZN9QVector4D4setZEf", ffiqt.FFI_TYPE_VOID, this.GetCthis(), &z)
	gopp.ErrPrint(err, rv)
}
...
func (this *QVector4D) SetW(w float32) {
	// 0: (, w float), (&w)
	rv, err := ffiqt.InvokeQtFunc6("_ZN9QVector4D4setWEf", ffiqt.FFI_TYPE_VOID, this.GetCthis(), &w)
	gopp.ErrPrint(err, rv)
}
...
func (this *QVector4D) Length() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK9QVector4D6lengthEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QVector4D) LengthSquared() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK9QVector4D13lengthSquaredEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QVector4D) Normalized() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK9QVector4D10normalizedEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QVector4D) Normalize() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZN9QVector4D9normalizeEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QVector4D) DotProduct(v1 unsafe.Pointer, v2 unsafe.Pointer) {
	// 0: (v1 const QVector4D &, v2 const QVector4D &), (v1, v2)
...
func (this *QVector4D) ToVector2D() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK9QVector4D10toVector2DEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QVector4D) ToVector2DAffine() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK9QVector4D16toVector2DAffineEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QVector4D) ToVector3D() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK9QVector4D10toVector3DEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QVector4D) ToVector3DAffine() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK9QVector4D16toVector3DAffineEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QVector4D) ToPoint() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK9QVector4D7toPointEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QVector4D) ToPointF() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK9QVector4D8toPointFEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
