...
func (this *QAccessibleEvent) Type() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK16QAccessibleEvent4typeEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QAccessibleEvent) Object() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK16QAccessibleEvent6objectEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QAccessibleEvent) UniqueId() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK16QAccessibleEvent8uniqueIdEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QAccessibleEvent) SetChild(chld int) {
	// 0: (, chld int), (&chld)
	rv, err := ffiqt.InvokeQtFunc6("_ZN16QAccessibleEvent8setChildEi", ffiqt.FFI_TYPE_VOID, this.GetCthis(), &chld)
	gopp.ErrPrint(err, rv)
}
...
func (this *QAccessibleEvent) Child() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK16QAccessibleEvent5childEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QAccessibleEvent) AccessibleInterface() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK16QAccessibleEvent19accessibleInterfaceEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
