...
func (this *QRgba64) FromRgba64_1(red uint16, green uint16, blue uint16, alpha uint16) {
	// 1: (quint16 red, quint16 green, quint16 blue, quint16 alpha), (red, green, blue, alpha)
...
func (this *QRgba64) FromRgba(red byte, green byte, blue byte, alpha byte) {
	// 0: (quint8 red, quint8 green, quint8 blue, quint8 alpha), (red, green, blue, alpha)
...
func (this *QRgba64) IsOpaque() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK7QRgba648isOpaqueEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QRgba64) IsTransparent() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK7QRgba6413isTransparentEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QRgba64) Red() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK7QRgba643redEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QRgba64) Green() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK7QRgba645greenEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QRgba64) Blue() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK7QRgba644blueEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QRgba64) Alpha() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK7QRgba645alphaEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QRgba64) SetRed(_red uint16) {
	// 0: (, quint16 _red), (&_red)
	rv, err := ffiqt.InvokeQtFunc6("_ZN7QRgba646setRedEt", ffiqt.FFI_TYPE_VOID, this.cthis, &_red)
	gopp.ErrPrint(err, rv)
}
...
func (this *QRgba64) SetGreen(_green uint16) {
	// 0: (, quint16 _green), (&_green)
	rv, err := ffiqt.InvokeQtFunc6("_ZN7QRgba648setGreenEt", ffiqt.FFI_TYPE_VOID, this.cthis, &_green)
	gopp.ErrPrint(err, rv)
}
...
func (this *QRgba64) SetBlue(_blue uint16) {
	// 0: (, quint16 _blue), (&_blue)
	rv, err := ffiqt.InvokeQtFunc6("_ZN7QRgba647setBlueEt", ffiqt.FFI_TYPE_VOID, this.cthis, &_blue)
	gopp.ErrPrint(err, rv)
}
...
func (this *QRgba64) SetAlpha(_alpha uint16) {
	// 0: (, quint16 _alpha), (&_alpha)
	rv, err := ffiqt.InvokeQtFunc6("_ZN7QRgba648setAlphaEt", ffiqt.FFI_TYPE_VOID, this.cthis, &_alpha)
	gopp.ErrPrint(err, rv)
}
...
func (this *QRgba64) Red8() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK7QRgba644red8Ev", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QRgba64) Green8() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK7QRgba646green8Ev", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QRgba64) Blue8() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK7QRgba645blue8Ev", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QRgba64) Alpha8() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK7QRgba646alpha8Ev", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QRgba64) ToArgb32() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK7QRgba648toArgb32Ev", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QRgba64) ToRgb16() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK7QRgba647toRgb16Ev", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QRgba64) Premultiplied() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK7QRgba6413premultipliedEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QRgba64) Unpremultiplied() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK7QRgba6415unpremultipliedEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
