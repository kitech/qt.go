...
func (this *QAccessibleBridge) SetRootObject(arg0 *QAccessibleInterface /*444 QAccessibleInterface **/) {
...
func (this *QAccessibleBridge) NotifyAccessibilityUpdate(event *QAccessibleEvent /*444 QAccessibleEvent **/) {
