...
func (this *QBrush) Swap(other unsafe.Pointer) {
	// 0: (, QBrush & other), (other)
	rv, err := ffiqt.InvokeQtFunc6("_ZN6QBrush4swapERS_", ffiqt.FFI_TYPE_VOID, this.cthis, other)
	gopp.ErrPrint(err, rv)
}
...
func (this *QBrush) Style() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK6QBrush5styleEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QBrush) SetStyle(arg0 int) {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN6QBrush8setStyleEN2Qt10BrushStyleE", ffiqt.FFI_TYPE_VOID, this.cthis, &arg0)
	gopp.ErrPrint(err, rv)
}
...
func (this *QBrush) Matrix() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK6QBrush6matrixEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QBrush) SetMatrix(mat unsafe.Pointer) {
	// 0: (, const QMatrix & mat), (mat)
	rv, err := ffiqt.InvokeQtFunc6("_ZN6QBrush9setMatrixERK7QMatrix", ffiqt.FFI_TYPE_VOID, this.cthis, mat)
	gopp.ErrPrint(err, rv)
}
...
func (this *QBrush) Transform() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK6QBrush9transformEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QBrush) SetTransform(arg0 unsafe.Pointer) {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN6QBrush12setTransformERK10QTransform", ffiqt.FFI_TYPE_VOID, this.cthis, arg0)
	gopp.ErrPrint(err, rv)
}
...
func (this *QBrush) Texture() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK6QBrush7textureEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QBrush) SetTexture(pixmap unsafe.Pointer) {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN6QBrush10setTextureERK7QPixmap", ffiqt.FFI_TYPE_VOID, this.cthis, pixmap)
	gopp.ErrPrint(err, rv)
}
...
func (this *QBrush) TextureImage() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK6QBrush12textureImageEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QBrush) SetTextureImage(image unsafe.Pointer) {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN6QBrush15setTextureImageERK6QImage", ffiqt.FFI_TYPE_VOID, this.cthis, image)
	gopp.ErrPrint(err, rv)
}
...
func (this *QBrush) Color() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK6QBrush5colorEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QBrush) SetColor(color unsafe.Pointer) {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN6QBrush8setColorERK6QColor", ffiqt.FFI_TYPE_VOID, this.cthis, color)
	gopp.ErrPrint(err, rv)
}
...
func (this *QBrush) SetColor_1(color int) {
	// 1: (, Qt::GlobalColor color), (&color)
	rv, err := ffiqt.InvokeQtFunc6("_ZN6QBrush8setColorEN2Qt11GlobalColorE", ffiqt.FFI_TYPE_VOID, this.cthis, &color)
	gopp.ErrPrint(err, rv)
}
...
func (this *QBrush) Gradient() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK6QBrush8gradientEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QBrush) IsOpaque() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK6QBrush8isOpaqueEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QBrush) IsDetached() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK6QBrush10isDetachedEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
