...
func (this *QIntValidator) MetaObject() interface{} {
...
func (this *QIntValidator) Validate(arg0 *qtcore.QString, arg1 int) interface{} {
...
// Public inline
// int bottom()
func (this *QIntValidator) Bottom() interface{} {
...
// Public inline
// int top()
func (this *QIntValidator) Top() interface{} {
