...
func (this *QColorDialog) MetaObject() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK12QColorDialog10metaObjectEv", ffiqt.FFI_TYPE_VOID, this.cthis)
...
func (this *QColorDialog) SetCurrentColor(color unsafe.Pointer) {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN12QColorDialog15setCurrentColorERK6QColor", ffiqt.FFI_TYPE_VOID, this.cthis, color)
	gopp.ErrPrint(err, rv)
}
...
func (this *QColorDialog) CurrentColor() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK12QColorDialog12currentColorEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QColorDialog) SelectedColor() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK12QColorDialog13selectedColorEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QColorDialog) SetOption(option int, on bool) {
	// 0: (, QColorDialog::ColorDialogOption option, bool on), (&option, &on)
	rv, err := ffiqt.InvokeQtFunc6("_ZN12QColorDialog9setOptionENS_17ColorDialogOptionEb", ffiqt.FFI_TYPE_VOID, this.cthis, &option, &on)
	gopp.ErrPrint(err, rv)
}
...
func (this *QColorDialog) TestOption(option int) {
	// 0: (, QColorDialog::ColorDialogOption option), (&option)
	rv, err := ffiqt.InvokeQtFunc6("_ZNK12QColorDialog10testOptionENS_17ColorDialogOptionE", ffiqt.FFI_TYPE_VOID, this.cthis, &option)
	gopp.ErrPrint(err, rv)
}
...
func (this *QColorDialog) Options() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK12QColorDialog7optionsEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QColorDialog) Open(receiver unsafe.Pointer, member unsafe.Pointer) {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN12QColorDialog4openEP7QObjectPKc", ffiqt.FFI_TYPE_VOID, this.cthis, receiver, member)
	gopp.ErrPrint(err, rv)
}
...
func (this *QColorDialog) SetVisible(visible bool) {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN12QColorDialog10setVisibleEb", ffiqt.FFI_TYPE_VOID, this.cthis, &visible)
	gopp.ErrPrint(err, rv)
}
...
func (this *QColorDialog) GetRgba(rgba uint, ok unsafe.Pointer, parent unsafe.Pointer) {
	// 0: (QRgb rgba, bool * ok, QWidget * parent), (rgba, ok, parent)
...
func (this *QColorDialog) SetCustomColor(index int, color unsafe.Pointer) {
	// 0: (int index, QColor color), (index, color)
...
func (this *QColorDialog) CurrentColorChanged(color unsafe.Pointer) {
	// 0: (, const QColor & color), (color)
	rv, err := ffiqt.InvokeQtFunc6("_ZN12QColorDialog19currentColorChangedERK6QColor", ffiqt.FFI_TYPE_VOID, this.cthis, color)
	gopp.ErrPrint(err, rv)
}
...
func (this *QColorDialog) ColorSelected(color unsafe.Pointer) {
	// 0: (, const QColor & color), (color)
	rv, err := ffiqt.InvokeQtFunc6("_ZN12QColorDialog13colorSelectedERK6QColor", ffiqt.FFI_TYPE_VOID, this.cthis, color)
	gopp.ErrPrint(err, rv)
}
