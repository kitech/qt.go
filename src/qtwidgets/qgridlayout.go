...
func (this *QGridLayout) MetaObject() interface{} {
...
// Public virtual
// QSize sizeHint()
func (this *QGridLayout) SizeHint() interface{} {
...
// Public virtual
// QSize minimumSize()
func (this *QGridLayout) MinimumSize() interface{} {
...
// Public virtual
// QSize maximumSize()
func (this *QGridLayout) MaximumSize() interface{} {
...
func (this *QGridLayout) HorizontalSpacing() interface{} {
...
// Public
// int verticalSpacing()
func (this *QGridLayout) VerticalSpacing() interface{} {
...
// Public
// int spacing()
func (this *QGridLayout) Spacing() interface{} {
...
// Public
// int rowStretch(int)
func (this *QGridLayout) RowStretch(row int) interface{} {
...
func (this *QGridLayout) ColumnStretch(column int) interface{} {
...
func (this *QGridLayout) RowMinimumHeight(row int) interface{} {
...
func (this *QGridLayout) ColumnMinimumWidth(column int) interface{} {
...
// Public
// int columnCount()
func (this *QGridLayout) ColumnCount() interface{} {
...
// Public
// int rowCount()
func (this *QGridLayout) RowCount() interface{} {
...
func (this *QGridLayout) CellRect(row int, column int) interface{} {
...
func (this *QGridLayout) HasHeightForWidth() interface{} {
...
func (this *QGridLayout) HeightForWidth(arg0 int) interface{} {
...
func (this *QGridLayout) MinimumHeightForWidth(arg0 int) interface{} {
...
func (this *QGridLayout) ExpandingDirections() interface{} {
...
func (this *QGridLayout) AddWidget(w unsafe.Pointer) {
	rv, err := ffiqt.InvokeQtFunc6("_ZN11QGridLayout9addWidgetEP7QWidget", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), w)
	gopp.ErrPrint(err, rv)
}
...
func (this *QGridLayout) OriginCorner() interface{} {
...
func (this *QGridLayout) ItemAt(index int) interface{} {
...
func (this *QGridLayout) ItemAtPosition(row int, column int) interface{} {
...
func (this *QGridLayout) TakeAt(index int) interface{} {
...
// Public virtual
// int count()
func (this *QGridLayout) Count() interface{} {
...
func (this *QGridLayout) AddItem(arg0 unsafe.Pointer) {
	rv, err := ffiqt.InvokeQtFunc6("_ZN11QGridLayout7addItemEP11QLayoutItem", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), arg0)
	gopp.ErrPrint(err, rv)
}
