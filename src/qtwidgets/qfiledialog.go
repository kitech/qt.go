...
extern void C_ZNK11QFileDialog16supportedSchemesEv(void* qthis); // 4
...
extern void C_ZN11QFileDialog19setSupportedSchemesERK11QStringList(void* qthis, void* arg0); // 4
...
// supportedSchemes()
func (this *QFileDialog) Supportedschemes(args ...interface{}) () {
  // supportedSchemes()
  var vtys = make(map[int32]map[int32]reflect.Type)
  if false {fmt.Println(vtys)}
  vtys[0] = make(map[int32]reflect.Type)
  ...
  switch matched_index {
  case 0:
    // invoke: _ZNK11QFileDialog16supportedSchemesEv
    // invoke: QStringList supportedSchemes()
    C.C_ZNK11QFileDialog16supportedSchemesEv(this.Qclsinst)
  default:
    qtrt.ErrorResolve("QFileDialog", "supportedSchemes", args)
  }
...
// setSupportedSchemes(const class QStringList &)
func (this *QFileDialog) Setsupportedschemes(args ...interface{}) () {
  // setSupportedSchemes(const class QStringList &)
  var vtys = make(map[int32]map[int32]reflect.Type)
  if false {fmt.Println(vtys)}
  vtys[0] = make(map[int32]reflect.Type)
  ...
  switch matched_index {
  case 0:
    // invoke: _ZN11QFileDialog19setSupportedSchemesERK11QStringList
    // invoke: void setSupportedSchemes(const class QStringList &)
    var arg0 = args[0].(*qtcore.QStringList).Qclsinst
    if false {fmt.Println(arg0)}
    C.C_ZN11QFileDialog19setSupportedSchemesERK11QStringList(this.Qclsinst, arg0)
  default:
    qtrt.ErrorResolve("QFileDialog", "setSupportedSchemes", args)
  }
