...
func (this *QTreeWidgetItem) Setforeground(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = C.int32_t(qtrt.PrimConv(args[0], qtrt.Int32Ty(false)).(int32))
    if false {fmt.Println(arg0)}
    var arg1 = args[1].(*qtgui.QBrush).Qclsinst
    if false {fmt.Println(arg1)}
...
func NewQTreeWidgetItem(args ...interface{}) *QTreeWidgetItem {
  ...
  vtys[4][1] = reflect.TypeOf(qtcore.QStringList{}) // "const QStringList &"
  ...
  vtys[6][0] = reflect.TypeOf(qtcore.QStringList{}) // "const QStringList &"
