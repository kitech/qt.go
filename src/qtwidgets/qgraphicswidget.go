...
func (this *QGraphicsWidget) MetaObject() interface{} {
...
func (this *QGraphicsWidget) Layout() interface{} {
...
func (this *QGraphicsWidget) SetLayout(layout unsafe.Pointer) {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QGraphicsWidget9setLayoutEP15QGraphicsLayout", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), layout)
	gopp.ErrPrint(err, rv)
}
...
func (this *QGraphicsWidget) LayoutDirection() interface{} {
...
// Public
// QStyle * style()
func (this *QGraphicsWidget) Style() interface{} {
...
func (this *QGraphicsWidget) SetStyle(style unsafe.Pointer) {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QGraphicsWidget8setStyleEP6QStyle", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), style)
	gopp.ErrPrint(err, rv)
}
...
// Public
// QFont font()
func (this *QGraphicsWidget) Font() interface{} {
...
// Public
// QPalette palette()
func (this *QGraphicsWidget) Palette() interface{} {
...
func (this *QGraphicsWidget) AutoFillBackground() interface{} {
...
// Public
// QSizeF size()
func (this *QGraphicsWidget) Size() interface{} {
...
// Public inline
// QRectF rect()
func (this *QGraphicsWidget) Rect() interface{} {
...
func (this *QGraphicsWidget) WindowFrameGeometry() interface{} {
...
func (this *QGraphicsWidget) WindowFrameRect() interface{} {
...
func (this *QGraphicsWidget) WindowFlags() interface{} {
...
func (this *QGraphicsWidget) WindowType() interface{} {
...
// Public
// bool isActiveWindow()
func (this *QGraphicsWidget) IsActiveWindow() interface{} {
...
// Public
// QString windowTitle()
func (this *QGraphicsWidget) WindowTitle() interface{} {
...
func (this *QGraphicsWidget) FocusPolicy() interface{} {
...
func (this *QGraphicsWidget) FocusWidget() interface{} {
...
func (this *QGraphicsWidget) GrabShortcut(sequence *qtgui.QKeySequence, context int) interface{} {
...
func (this *QGraphicsWidget) AddAction(action unsafe.Pointer) {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QGraphicsWidget9addActionEP7QAction", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), action)
	gopp.ErrPrint(err, rv)
}
...
func (this *QGraphicsWidget) InsertAction(before unsafe.Pointer, action unsafe.Pointer) {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QGraphicsWidget12insertActionEP7QActionS1_", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), before, action)
	gopp.ErrPrint(err, rv)
}
...
func (this *QGraphicsWidget) RemoveAction(action unsafe.Pointer) {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QGraphicsWidget12removeActionEP7QAction", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), action)
	gopp.ErrPrint(err, rv)
}
...
func (this *QGraphicsWidget) Actions() interface{} {
	rv, err := ffiqt.InvokeQtFunc6("_ZNK15QGraphicsWidget7actionsEv", ffiqt.FFI_TYPE_POINTER, this.GetCthis())
	gopp.ErrPrint(err, rv)
	return rv
}
...
func (this *QGraphicsWidget) TestAttribute(attribute int) interface{} {
...
// Public virtual
// int type()
func (this *QGraphicsWidget) Type() interface{} {
...
func (this *QGraphicsWidget) Paint(painter unsafe.Pointer, option unsafe.Pointer, widget unsafe.Pointer) {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QGraphicsWidget5paintEP8QPainterPK24QStyleOptionGraphicsItemP7QWidget", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), painter, option, widget)
	gopp.ErrPrint(err, rv)
}
...
func (this *QGraphicsWidget) PaintWindowFrame(painter unsafe.Pointer, option unsafe.Pointer, widget unsafe.Pointer) {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QGraphicsWidget16paintWindowFrameEP8QPainterPK24QStyleOptionGraphicsItemP7QWidget", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), painter, option, widget)
	gopp.ErrPrint(err, rv)
}
...
// Public virtual
// QRectF boundingRect()
func (this *QGraphicsWidget) BoundingRect() interface{} {
...
// Public virtual
// QPainterPath shape()
func (this *QGraphicsWidget) Shape() interface{} {
...
// Public
// bool close()
func (this *QGraphicsWidget) Close() interface{} {
...
func (this *QGraphicsWidget) InitStyleOption(option unsafe.Pointer) {
	rv, err := ffiqt.InvokeQtFunc6("_ZNK15QGraphicsWidget15initStyleOptionEP12QStyleOption", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), option)
	gopp.ErrPrint(err, rv)
}
...
func (this *QGraphicsWidget) SizeHint(which int, constraint *qtcore.QSizeF) interface{} {
...
func (this *QGraphicsWidget) ItemChange(change int, value *qtcore.QVariant) interface{} {
...
func (this *QGraphicsWidget) PropertyChange(propertyName *qtcore.QString, value *qtcore.QVariant) interface{} {
...
func (this *QGraphicsWidget) SceneEvent(event unsafe.Pointer) interface{} {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QGraphicsWidget10sceneEventEP6QEvent", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), event)
	gopp.ErrPrint(err, rv)
	return rv
}
...
func (this *QGraphicsWidget) WindowFrameEvent(e unsafe.Pointer) interface{} {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QGraphicsWidget16windowFrameEventEP6QEvent", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), e)
	gopp.ErrPrint(err, rv)
	return rv
}
...
func (this *QGraphicsWidget) WindowFrameSectionAt(pos *qtcore.QPointF) interface{} {
...
func (this *QGraphicsWidget) Event(event unsafe.Pointer) interface{} {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QGraphicsWidget5eventEP6QEvent", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), event)
	gopp.ErrPrint(err, rv)
	return rv
}
...
func (this *QGraphicsWidget) ChangeEvent(event unsafe.Pointer) {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QGraphicsWidget11changeEventEP6QEvent", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), event)
	gopp.ErrPrint(err, rv)
}
...
func (this *QGraphicsWidget) CloseEvent(event unsafe.Pointer) {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QGraphicsWidget10closeEventEP11QCloseEvent", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), event)
	gopp.ErrPrint(err, rv)
}
...
func (this *QGraphicsWidget) FocusInEvent(event unsafe.Pointer) {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QGraphicsWidget12focusInEventEP11QFocusEvent", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), event)
	gopp.ErrPrint(err, rv)
}
...
func (this *QGraphicsWidget) FocusNextPrevChild(next bool) interface{} {
...
func (this *QGraphicsWidget) FocusOutEvent(event unsafe.Pointer) {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QGraphicsWidget13focusOutEventEP11QFocusEvent", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), event)
	gopp.ErrPrint(err, rv)
}
...
func (this *QGraphicsWidget) HideEvent(event unsafe.Pointer) {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QGraphicsWidget9hideEventEP10QHideEvent", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), event)
	gopp.ErrPrint(err, rv)
}
...
func (this *QGraphicsWidget) MoveEvent(event unsafe.Pointer) {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QGraphicsWidget9moveEventEP23QGraphicsSceneMoveEvent", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), event)
	gopp.ErrPrint(err, rv)
}
...
func (this *QGraphicsWidget) ResizeEvent(event unsafe.Pointer) {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QGraphicsWidget11resizeEventEP25QGraphicsSceneResizeEvent", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), event)
	gopp.ErrPrint(err, rv)
}
...
func (this *QGraphicsWidget) ShowEvent(event unsafe.Pointer) {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QGraphicsWidget9showEventEP10QShowEvent", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), event)
	gopp.ErrPrint(err, rv)
}
...
func (this *QGraphicsWidget) HoverMoveEvent(event unsafe.Pointer) {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QGraphicsWidget14hoverMoveEventEP24QGraphicsSceneHoverEvent", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), event)
	gopp.ErrPrint(err, rv)
}
...
func (this *QGraphicsWidget) HoverLeaveEvent(event unsafe.Pointer) {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QGraphicsWidget15hoverLeaveEventEP24QGraphicsSceneHoverEvent", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), event)
	gopp.ErrPrint(err, rv)
}
...
func (this *QGraphicsWidget) GrabMouseEvent(event unsafe.Pointer) {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QGraphicsWidget14grabMouseEventEP6QEvent", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), event)
	gopp.ErrPrint(err, rv)
}
...
func (this *QGraphicsWidget) UngrabMouseEvent(event unsafe.Pointer) {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QGraphicsWidget16ungrabMouseEventEP6QEvent", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), event)
	gopp.ErrPrint(err, rv)
}
...
func (this *QGraphicsWidget) GrabKeyboardEvent(event unsafe.Pointer) {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QGraphicsWidget17grabKeyboardEventEP6QEvent", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), event)
	gopp.ErrPrint(err, rv)
}
...
func (this *QGraphicsWidget) UngrabKeyboardEvent(event unsafe.Pointer) {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QGraphicsWidget19ungrabKeyboardEventEP6QEvent", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), event)
	gopp.ErrPrint(err, rv)
}
