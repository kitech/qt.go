...
func (this *QTime) IsNull() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK5QTime6isNullEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QTime) IsValid() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK5QTime7isValidEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QTime) IsValid_1(h int, m int, s int, ms int) {
	// 1: (h int, m int, s int, ms int), (h, m, s, ms)
...
func (this *QTime) Hour() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK5QTime4hourEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QTime) Minute() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK5QTime6minuteEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QTime) Second() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK5QTime6secondEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QTime) Msec() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK5QTime4msecEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QTime) ToString(f int) {
	// 0: (, f Qt::DateFormat), (&f)
	rv, err := ffiqt.InvokeQtFunc6("_ZNK5QTime8toStringEN2Qt10DateFormatE", ffiqt.FFI_TYPE_VOID, this.GetCthis(), &f)
	gopp.ErrPrint(err, rv)
}
...
func (this *QTime) ToString_1(format unsafe.Pointer) {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZNK5QTime8toStringERK7QString", ffiqt.FFI_TYPE_VOID, this.GetCthis(), format)
	gopp.ErrPrint(err, rv)
}
...
func (this *QTime) ToString_2(format unsafe.Pointer) {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZNK5QTime8toStringE11QStringView", ffiqt.FFI_TYPE_VOID, this.GetCthis(), format)
	gopp.ErrPrint(err, rv)
}
...
func (this *QTime) SetHMS(h int, m int, s int, ms int) {
	// 0: (, h int, m int, s int, ms int), (&h, &m, &s, &ms)
	rv, err := ffiqt.InvokeQtFunc6("_ZN5QTime6setHMSEiiii", ffiqt.FFI_TYPE_VOID, this.GetCthis(), &h, &m, &s, &ms)
	gopp.ErrPrint(err, rv)
}
...
func (this *QTime) AddSecs(secs int) {
	// 0: (, secs int), (&secs)
	rv, err := ffiqt.InvokeQtFunc6("_ZNK5QTime7addSecsEi", ffiqt.FFI_TYPE_VOID, this.GetCthis(), &secs)
	gopp.ErrPrint(err, rv)
}
...
func (this *QTime) SecsTo(arg0 unsafe.Pointer) {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZNK5QTime6secsToERKS_", ffiqt.FFI_TYPE_VOID, this.GetCthis(), arg0)
	gopp.ErrPrint(err, rv)
}
...
func (this *QTime) AddMSecs(ms int) {
	// 0: (, ms int), (&ms)
	rv, err := ffiqt.InvokeQtFunc6("_ZNK5QTime8addMSecsEi", ffiqt.FFI_TYPE_VOID, this.GetCthis(), &ms)
	gopp.ErrPrint(err, rv)
}
...
func (this *QTime) MsecsTo(arg0 unsafe.Pointer) {
	// 0: (, const QTime & arg0), (arg0)
	rv, err := ffiqt.InvokeQtFunc6("_ZNK5QTime7msecsToERKS_", ffiqt.FFI_TYPE_VOID, this.GetCthis(), arg0)
	gopp.ErrPrint(err, rv)
}
...
func (this *QTime) MsecsSinceStartOfDay() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK5QTime20msecsSinceStartOfDayEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QTime) Start() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZN5QTime5startEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QTime) Restart() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZN5QTime7restartEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QTime) Elapsed() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK5QTime7elapsedEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
