...
func (this *QStringMatcher) SetPattern(pattern unsafe.Pointer) {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN14QStringMatcher10setPatternERK7QString", ffiqt.FFI_TYPE_VOID, this.GetCthis(), pattern)
	gopp.ErrPrint(err, rv)
}
...
func (this *QStringMatcher) SetCaseSensitivity(cs int) {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN14QStringMatcher18setCaseSensitivityEN2Qt15CaseSensitivityE", ffiqt.FFI_TYPE_VOID, this.GetCthis(), &cs)
	gopp.ErrPrint(err, rv)
}
...
func (this *QStringMatcher) IndexIn(str unsafe.Pointer, from int) {
	// 0: (, str const QString &, from int), (str, &from)
	rv, err := ffiqt.InvokeQtFunc6("_ZNK14QStringMatcher7indexInERK7QStringi", ffiqt.FFI_TYPE_VOID, this.GetCthis(), str, &from)
	gopp.ErrPrint(err, rv)
}
...
func (this *QStringMatcher) IndexIn_1(str unsafe.Pointer, length int, from int) {
	// 1: (, str const QChar *, length int, from int), (str, &length, &from)
	rv, err := ffiqt.InvokeQtFunc6("_ZNK14QStringMatcher7indexInEPK5QCharii", ffiqt.FFI_TYPE_VOID, this.GetCthis(), str, &length, &from)
	gopp.ErrPrint(err, rv)
}
...
func (this *QStringMatcher) Pattern() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK14QStringMatcher7patternEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
...
func (this *QStringMatcher) CaseSensitivity() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK14QStringMatcher15caseSensitivityEv", ffiqt.FFI_TYPE_VOID, this.GetCthis())
	gopp.ErrPrint(err, rv)
}
