...
// Public inline
// bool isNull()
func (this *QLine) IsNull() interface{} {
...
func (this *QLine) Translated(p *QPoint) interface{} {
	var convArg0 = p.GetCthis()
...
func (this *QLine) Translated_1(dx int, dy int) interface{} {
...
// Public inline
// QPoint center()
func (this *QLine) Center() interface{} {
