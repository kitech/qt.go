...
extern int32_t C_ZNK6QDebug9verbosityEv(void* qthis); // 2
...
extern void C_ZN6QDebug12setVerbosityEi(void* qthis, int32_t arg0); // 2
...
// verbosity()
func (this *QDebug) Verbosity(args ...interface{}) (ret interface{}) {
  // verbosity()
  var vtys = make(map[int32]map[int32]reflect.Type)
  if false {fmt.Println(vtys)}
  vtys[0] = make(map[int32]reflect.Type)
  ...
  switch matched_index {
  case 0:
    // invoke: _ZNK6QDebug9verbosityEv
    // invoke: int verbosity()
    var ret0 = C.C_ZNK6QDebug9verbosityEv(this.Qclsinst)
    if false {reflect.TypeOf(ret0)}
    ret = ret0
  ...
  default:
    qtrt.ErrorResolve("QDebug", "verbosity", args)
  }
...
// setVerbosity(int)
func (this *QDebug) Setverbosity(args ...interface{}) () {
  // setVerbosity(int)
  var vtys = make(map[int32]map[int32]reflect.Type)
  if false {fmt.Println(vtys)}
  vtys[0] = make(map[int32]reflect.Type)
  ...
  switch matched_index {
  case 0:
    // invoke: _ZN6QDebug12setVerbosityEi
    // invoke: void setVerbosity(int)
    var arg0 = C.int32_t(qtrt.PrimConv(args[0], qtrt.Int32Ty(false)).(int32))
    if false {fmt.Println(arg0)}
    C.C_ZN6QDebug12setVerbosityEi(this.Qclsinst, arg0)
  default:
    qtrt.ErrorResolve("QDebug", "setVerbosity", args)
  }
