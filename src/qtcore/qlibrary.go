...
func (this *QLibrary) MetaObject() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK8QLibrary10metaObjectEv", ffiqt.FFI_TYPE_VOID, this.cthis)
...
func (this *QLibrary) Resolve(symbol unsafe.Pointer) {
	// 0: (, const char * symbol), (symbol)
	rv, err := ffiqt.InvokeQtFunc6("_ZN8QLibrary7resolveEPKc", ffiqt.FFI_TYPE_VOID, this.cthis, symbol)
	gopp.ErrPrint(err, rv)
}
...
func (this *QLibrary) Resolve_1(fileName unsafe.Pointer, symbol unsafe.Pointer) {
	// 1: (const QString & fileName, const char * symbol), (fileName, symbol)
...
func (this *QLibrary) Resolve_2(fileName unsafe.Pointer, verNum int, symbol unsafe.Pointer) {
	// 2: (const QString & fileName, int verNum, const char * symbol), (fileName, verNum, symbol)
...
func (this *QLibrary) Resolve_3(fileName unsafe.Pointer, version unsafe.Pointer, symbol unsafe.Pointer) {
	// 3: (const QString & fileName, const QString & version, const char * symbol), (fileName, version, symbol)
...
func (this *QLibrary) Load() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZN8QLibrary4loadEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QLibrary) Unload() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZN8QLibrary6unloadEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QLibrary) IsLoaded() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK8QLibrary8isLoadedEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QLibrary) SetFileName(fileName unsafe.Pointer) {
	// 0: (, const QString & fileName), (fileName)
	rv, err := ffiqt.InvokeQtFunc6("_ZN8QLibrary11setFileNameERK7QString", ffiqt.FFI_TYPE_VOID, this.cthis, fileName)
	gopp.ErrPrint(err, rv)
}
...
func (this *QLibrary) FileName() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK8QLibrary8fileNameEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QLibrary) SetFileNameAndVersion(fileName unsafe.Pointer, verNum int) {
	// 0: (, const QString & fileName, int verNum), (fileName, &verNum)
	rv, err := ffiqt.InvokeQtFunc6("_ZN8QLibrary21setFileNameAndVersionERK7QStringi", ffiqt.FFI_TYPE_VOID, this.cthis, fileName, &verNum)
	gopp.ErrPrint(err, rv)
}
...
func (this *QLibrary) SetFileNameAndVersion_1(fileName unsafe.Pointer, version unsafe.Pointer) {
	// 1: (, const QString & fileName, const QString & version), (fileName, version)
	rv, err := ffiqt.InvokeQtFunc6("_ZN8QLibrary21setFileNameAndVersionERK7QStringS2_", ffiqt.FFI_TYPE_VOID, this.cthis, fileName, version)
	gopp.ErrPrint(err, rv)
}
...
func (this *QLibrary) ErrorString() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK8QLibrary11errorStringEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
...
func (this *QLibrary) LoadHints() {
	// 0: (), ()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK8QLibrary9loadHintsEv", ffiqt.FFI_TYPE_VOID, this.cthis)
	gopp.ErrPrint(err, rv)
}
