...
extern void C_ZN9QListData12realloc_growEi(void* qthis, int32_t arg0); // 4
...
// realloc_grow(int)
func (this *QListData) Realloc_Grow(args ...interface{}) () {
  // realloc_grow(int)
  var vtys = make(map[int32]map[int32]reflect.Type)
  if false {fmt.Println(vtys)}
  vtys[0] = make(map[int32]reflect.Type)
  ...
  switch matched_index {
  case 0:
    // invoke: _ZN9QListData12realloc_growEi
    // invoke: void realloc_grow(int)
    var arg0 = C.int32_t(qtrt.PrimConv(args[0], qtrt.Int32Ty(false)).(int32))
    if false {fmt.Println(arg0)}
    C.C_ZN9QListData12realloc_growEi(this.Qclsinst, arg0)
  default:
    qtrt.ErrorResolve("QListData", "realloc_grow", args)
  }
