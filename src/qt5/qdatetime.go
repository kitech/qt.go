...
extern void _ZN5QTime10fromStringERK7QStringS2_(void* arg0, void* arg1); // 4
  // proto:  void QTime::QTime(int h, int m, int s, int ms);
extern void _ZN5QTimeC2Eiiii(void* qthis, int32_t arg0, int32_t arg1, int32_t arg2, int32_t arg3); // 3
  // proto:  void QTime::QTime();
extern void _ZN5QTimeC2Ev(void* qthis); // 1
  // proto:  int QTime::msec();
extern void _ZNK5QTime4msecEv(void* qthis); // 4
  // proto:  int QTime::second();
extern void _ZNK5QTime6secondEv(void* qthis); // 4
  // proto:  int QTime::msecsSinceStartOfDay();
extern void _ZNK5QTime20msecsSinceStartOfDayEv(void* qthis); // 2
  // proto:  bool QTime::setHMS(int h, int m, int s, int ms);
extern void _ZN5QTime6setHMSEiiii(void* qthis, int32_t arg0, int32_t arg1, int32_t arg2, int32_t arg3); // 4
  // proto:  QTime QTime::addMSecs(int ms);
extern void _ZNK5QTime8addMSecsEi(void* qthis, int32_t arg0); // 4
  // proto:  void QTime::start();
extern void _ZN5QTime5startEv(void* qthis); // 4
  // proto: static QTime QTime::fromMSecsSinceStartOfDay(int msecs);
extern void _ZN5QTime24fromMSecsSinceStartOfDayEi(int32_t arg0); // 2
  // proto:  int QTime::minute();
extern void _ZNK5QTime6minuteEv(void* qthis); // 4
  // proto:  QString QTime::toString(const QString & format);
extern void _ZNK5QTime8toStringERK7QString(void* qthis, void* arg0); // 4
  // proto: static bool QTime::isValid(int h, int m, int s, int ms);
extern void _ZN5QTime7isValidEiiii(int32_t arg0, int32_t arg1, int32_t arg2, int32_t arg3); // 4
  // proto:  bool QTime::isValid();
extern void _ZNK5QTime7isValidEv(void* qthis); // 4
  // proto:  int QTime::secsTo(const QTime & );
extern void _ZNK5QTime6secsToERKS_(void* qthis, void* arg0); // 4
  // proto:  int QTime::elapsed();
extern void _ZNK5QTime7elapsedEv(void* qthis); // 4
  // proto:  QTime QTime::addSecs(int secs);
extern void _ZNK5QTime7addSecsEi(void* qthis, int32_t arg0); // 4
  // proto:  int QTime::msecsTo(const QTime & );
extern void _ZNK5QTime7msecsToERKS_(void* qthis, void* arg0); // 4
  // proto:  int QTime::restart();
extern void _ZN5QTime7restartEv(void* qthis); // 4
  // proto:  int QTime::hour();
extern void _ZNK5QTime4hourEv(void* qthis); // 4
  // proto: static QTime QTime::currentTime();
extern void _ZN5QTime11currentTimeEv(); // 4
  // proto:  bool QTime::isNull();
extern void _ZNK5QTime6isNullEv(void* qthis); // 2
  // proto: static QDateTime QDateTime::fromString(const QString & s, const QString & format);
extern void _ZN9QDateTime10fromStringERK7QStringS2_(void* arg0, void* arg1); // 4
  // proto:  void QDateTime::setOffsetFromUtc(int offsetSeconds);
extern void _ZN9QDateTime16setOffsetFromUtcEi(void* qthis, int32_t arg0); // 4
  // proto:  uint QDateTime::toTime_t();
extern void _ZNK9QDateTime8toTime_tEv(void* qthis); // 4
  // proto:  QDateTime QDateTime::toTimeZone(const QTimeZone & toZone);
extern void _ZNK9QDateTime10toTimeZoneERK9QTimeZone(void* qthis, void* arg0); // 4
  // proto:  QDateTime QDateTime::toUTC();
extern void _ZNK9QDateTime5toUTCEv(void* qthis); // 2
  // proto:  void QDateTime::setUtcOffset(int seconds);
extern void _ZN9QDateTime12setUtcOffsetEi(void* qthis, int32_t arg0); // 4
  // proto:  void QDateTime::setTimeZone(const QTimeZone & toZone);
extern void _ZN9QDateTime11setTimeZoneERK9QTimeZone(void* qthis, void* arg0); // 4
  // proto:  void QDateTime::QDateTime(const QDateTime & other);
extern void _ZN9QDateTimeC2ERKS_(void* qthis, void* arg0); // 3
  // proto:  void QDateTime::QDateTime(const QDate & );
extern void _ZN9QDateTimeC2ERK5QDate(void* qthis, void* arg0); // 3
  // proto:  void QDateTime::QDateTime();
extern void _ZN9QDateTimeC2Ev(void* qthis); // 3
  // proto:  void QDateTime::QDateTime(const QDate & date, const QTime & time, const QTimeZone & timeZone);
extern void _ZN9QDateTimeC2ERK5QDateRK5QTimeRK9QTimeZone(void* qthis, void* arg0, void* arg1, void* arg2); // 3
  // proto:  void QDateTime::~QDateTime();
extern void _ZN9QDateTimeD2Ev(void* qthis); // 4
  // proto:  QDateTime QDateTime::toOffsetFromUtc(int offsetSeconds);
extern void _ZNK9QDateTime15toOffsetFromUtcEi(void* qthis, int32_t arg0); // 4
  // proto:  QDateTime QDateTime::addMSecs(qint64 msecs);
extern void _ZNK9QDateTime8addMSecsEx(void* qthis, int64_t arg0); // 4
  // proto:  QDateTime QDateTime::addMonths(int months);
extern void _ZNK9QDateTime9addMonthsEi(void* qthis, int32_t arg0); // 4
  // proto:  int QDateTime::offsetFromUtc();
extern void _ZNK9QDateTime13offsetFromUtcEv(void* qthis); // 4
  // proto:  QString QDateTime::toString(const QString & format);
extern void _ZNK9QDateTime8toStringERK7QString(void* qthis, void* arg0); // 4
  // proto:  void QDateTime::swap(QDateTime & other);
extern void _ZN9QDateTime4swapERS_(void* qthis, void* arg0); // 2
  // proto:  void QDateTime::setDate(const QDate & date);
extern void _ZN9QDateTime7setDateERK5QDate(void* qthis, void* arg0); // 4
  // proto: static QDateTime QDateTime::currentDateTime();
extern void _ZN9QDateTime15currentDateTimeEv(); // 4
  // proto: static QDateTime QDateTime::currentDateTimeUtc();
extern void _ZN9QDateTime18currentDateTimeUtcEv(); // 4
  // proto: static qint64 QDateTime::currentMSecsSinceEpoch();
extern void _ZN9QDateTime22currentMSecsSinceEpochEv(); // 4
  // proto:  bool QDateTime::isValid();
extern void _ZNK9QDateTime7isValidEv(void* qthis); // 4
  // proto:  qint64 QDateTime::secsTo(const QDateTime & );
extern void _ZNK9QDateTime6secsToERKS_(void* qthis, void* arg0); // 4
  // proto:  void QDateTime::setMSecsSinceEpoch(qint64 msecs);
extern void _ZN9QDateTime18setMSecsSinceEpochEx(void* qthis, int64_t arg0); // 4
  // proto:  QDateTime QDateTime::addDays(qint64 days);
extern void _ZNK9QDateTime7addDaysEx(void* qthis, int64_t arg0); // 4
  // proto:  void QDateTime::setTime_t(uint secsSince1Jan1970UTC);
extern void _ZN9QDateTime9setTime_tEj(void* qthis, int32_t arg0); // 4
  // proto:  QDateTime QDateTime::addSecs(qint64 secs);
extern void _ZNK9QDateTime7addSecsEx(void* qthis, int64_t arg0); // 4
  // proto:  QString QDateTime::timeZoneAbbreviation();
extern void _ZNK9QDateTime20timeZoneAbbreviationEv(void* qthis); // 4
  // proto:  void QDateTime::setTime(const QTime & time);
extern void _ZN9QDateTime7setTimeERK5QTime(void* qthis, void* arg0); // 4
  // proto:  qint64 QDateTime::toMSecsSinceEpoch();
extern void _ZNK9QDateTime17toMSecsSinceEpochEv(void* qthis); // 4
  // proto:  qint64 QDateTime::msecsTo(const QDateTime & );
extern void _ZNK9QDateTime7msecsToERKS_(void* qthis, void* arg0); // 4
  // proto:  QDate QDateTime::date();
extern void _ZNK9QDateTime4dateEv(void* qthis); // 4
  // proto:  qint64 QDateTime::daysTo(const QDateTime & );
extern void _ZNK9QDateTime6daysToERKS_(void* qthis, void* arg0); // 4
  // proto:  QDateTime QDateTime::toLocalTime();
extern void _ZNK9QDateTime11toLocalTimeEv(void* qthis); // 2
  // proto:  Qt::TimeSpec QDateTime::timeSpec();
extern void _ZNK9QDateTime8timeSpecEv(void* qthis); // 4
  // proto: static QDateTime QDateTime::fromTime_t(uint secsSince1Jan1970UTC, const QTimeZone & timeZone);
extern void _ZN9QDateTime10fromTime_tEjRK9QTimeZone(int32_t arg0, void* arg1); // 4
  // proto: static QDateTime QDateTime::fromTime_t(uint secsSince1Jan1970UTC);
extern void _ZN9QDateTime10fromTime_tEj(int32_t arg0); // 4
  // proto: static QDateTime QDateTime::fromMSecsSinceEpoch(qint64 msecs);
extern void _ZN9QDateTime19fromMSecsSinceEpochEx(int64_t arg0); // 4
  // proto: static QDateTime QDateTime::fromMSecsSinceEpoch(qint64 msecs, const QTimeZone & timeZone);
extern void _ZN9QDateTime19fromMSecsSinceEpochExRK9QTimeZone(int64_t arg0, void* arg1); // 4
  // proto:  bool QDateTime::isNull();
extern void _ZNK9QDateTime6isNullEv(void* qthis); // 4
  // proto:  int QDateTime::utcOffset();
extern void _ZNK9QDateTime9utcOffsetEv(void* qthis); // 4
  // proto:  QTime QDateTime::time();
extern void _ZNK9QDateTime4timeEv(void* qthis); // 4
  // proto:  QTimeZone QDateTime::timeZone();
extern void _ZNK9QDateTime8timeZoneEv(void* qthis); // 4
  // proto:  bool QDateTime::isDaylightTime();
extern void _ZNK9QDateTime14isDaylightTimeEv(void* qthis); // 4
  // proto:  QDateTime QDateTime::addYears(int years);
extern void _ZNK9QDateTime8addYearsEi(void* qthis, int32_t arg0); // 4
  // proto: static QDate QDate::fromString(const QString & s, const QString & format);
extern void _ZN5QDate10fromStringERK7QStringS2_(void* arg0, void* arg1); // 4
  // proto:  int QDate::month();
extern void _ZNK5QDate5monthEv(void* qthis); // 4
  // proto:  int QDate::year();
extern void _ZNK5QDate4yearEv(void* qthis); // 4
  // proto:  int QDate::daysInMonth();
extern void _ZNK5QDate11daysInMonthEv(void* qthis); // 4
  // proto:  qint64 QDate::daysTo(const QDate & );
extern void _ZNK5QDate6daysToERKS_(void* qthis, void* arg0); // 4
  // proto:  int QDate::weekNumber(int * yearNum);
extern void _ZNK5QDate10weekNumberEPi(void* qthis, int32_t* arg0); // 4
  // proto:  int QDate::daysInYear();
extern void _ZNK5QDate10daysInYearEv(void* qthis); // 4
  // proto:  QDate QDate::addMonths(int months);
extern void _ZNK5QDate9addMonthsEi(void* qthis, int32_t arg0); // 4
  // proto:  qint64 QDate::toJulianDay();
extern void _ZNK5QDate11toJulianDayEv(void* qthis); // 2
  // proto:  QString QDate::toString(const QString & format);
extern void _ZNK5QDate8toStringERK7QString(void* qthis, void* arg0); // 4
  // proto: static QDate QDate::fromJulianDay(qint64 jd);
extern void _ZN5QDate13fromJulianDayEx(int64_t arg0); // 2
  // proto:  bool QDate::setDate(int year, int month, int day);
extern void _ZN5QDate7setDateEiii(void* qthis, int32_t arg0, int32_t arg1, int32_t arg2); // 4
  // proto:  void QDate::getDate(int * year, int * month, int * day);
extern void _ZN5QDate7getDateEPiS0_S0_(void* qthis, int32_t* arg0, int32_t* arg1, int32_t* arg2); // 4
  // proto:  int QDate::dayOfWeek();
extern void _ZNK5QDate9dayOfWeekEv(void* qthis); // 4
  // proto: static bool QDate::isLeapYear(int year);
extern void _ZN5QDate10isLeapYearEi(int32_t arg0); // 4
  // proto:  void QDate::QDate();
extern void _ZN5QDateC2Ev(void* qthis); // 1
  // proto:  void QDate::QDate(int y, int m, int d);
extern void _ZN5QDateC2Eiii(void* qthis, int32_t arg0, int32_t arg1, int32_t arg2); // 3
  // proto:  bool QDate::isValid();
extern void _ZNK5QDate7isValidEv(void* qthis); // 2
  // proto: static bool QDate::isValid(int y, int m, int d);
extern void _ZN5QDate7isValidEiii(int32_t arg0, int32_t arg1, int32_t arg2); // 4
  // proto:  QDate QDate::addDays(qint64 days);
extern void _ZNK5QDate7addDaysEx(void* qthis, int64_t arg0); // 4
  // proto:  int QDate::day();
extern void _ZNK5QDate3dayEv(void* qthis); // 4
  // proto:  QDate QDate::addYears(int years);
extern void _ZNK5QDate8addYearsEi(void* qthis, int32_t arg0); // 4
  // proto:  bool QDate::isNull();
extern void _ZNK5QDate6isNullEv(void* qthis); // 2
  // proto:  int QDate::dayOfYear();
extern void _ZNK5QDate9dayOfYearEv(void* qthis); // 4
  // proto: static QDate QDate::currentDate();
extern void _ZN5QDate11currentDateEv(); // 4
*/
import "C"
// } // <= ext block end
...
func (this *QTime) fromString_s(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZN5QTime10fromStringERK7QStringS2_(arg0, arg1)
  default:
...
func NewQTime(args ...interface{}) QTime {
  ...
  case 0:
    ...
    C._ZN5QTimeC2Eiiii(qthis, arg0, arg1, arg2, arg3)
  case 1:
    // invoke: _ZN5QTimeC1Ev
    // invoke: void QTime()
    var qthis = unsafe.Pointer(C.malloc(5))
    if false {reflect.TypeOf(qthis)}
    C._ZN5QTimeC2Ev(qthis)
  default:
...
func (this *QTime) fromMSecsSinceStartOfDay_s(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = C.int32_t(args[0].(int32))
    if false {fmt.Println(arg0)}
    C._ZN5QTime24fromMSecsSinceStartOfDayEi(arg0)
  default:
...
func (this *QDateTime) fromString_s(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg1 = args[1].(QString).qclsinst
    if false {fmt.Println(arg1)}
    C._ZN9QDateTime10fromStringERK7QStringS2_(arg0, arg1)
  default:
...
func (this *QDateTime) toUTC(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK9QDateTime5toUTCEv(this.qclsinst)
  default:
...
func NewQDateTime(args ...interface{}) QDateTime {
  ...
  case 0:
    ...
    var qthis = unsafe.Pointer(C.malloc(5))
    if false {reflect.TypeOf(qthis)}
    C._ZN9QDateTimeC2ERKS_(qthis, arg0)
  case 1:
    ...
    var qthis = unsafe.Pointer(C.malloc(5))
    if false {reflect.TypeOf(qthis)}
    C._ZN9QDateTimeC2ERK5QDate(qthis, arg0)
  case 2:
    // invoke: _ZN9QDateTimeC1Ev
    // invoke: void QDateTime()
    var qthis = unsafe.Pointer(C.malloc(5))
    if false {reflect.TypeOf(qthis)}
    C._ZN9QDateTimeC2Ev(qthis)
  case 3:
    ...
    var qthis = unsafe.Pointer(C.malloc(5))
    if false {reflect.TypeOf(qthis)}
    C._ZN9QDateTimeC2ERK5QDateRK5QTimeRK9QTimeZone(qthis, arg0, arg1, arg2)
  default:
...
func (this *QDateTime) FreeQDateTime(args ...interface{}) () {
  ...
  case 0:
    ...
    // invoke: void ~QDateTime()
    C._ZN9QDateTimeD2Ev(this.qclsinst)
  default:
    qtrt.ErrorResolve("QDateTime", "~QDateTime", args)
  }
...
func (this *QDateTime) swap(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = args[0].(QDateTime).qclsinst
    if false {fmt.Println(arg0)}
    C._ZN9QDateTime4swapERS_(this.qclsinst, arg0)
  default:
...
func (this *QDateTime) currentDateTime_s(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZN9QDateTime15currentDateTimeEv()
  default:
...
func (this *QDateTime) currentDateTimeUtc_s(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZN9QDateTime18currentDateTimeUtcEv()
  default:
...
func (this *QDateTime) currentMSecsSinceEpoch_s(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZN9QDateTime22currentMSecsSinceEpochEv()
  default:
...
func (this *QDateTime) toLocalTime(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK9QDateTime11toLocalTimeEv(this.qclsinst)
  default:
...
func (this *QDateTime) timeSpec(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK9QDateTime8timeSpecEv(this.qclsinst)
  default:
...
func (this *QDateTime) fromTime_t_s(args ...interface{}) () {
  ...
  case 0:
    ...
    if false {fmt.Println(arg1)}
    C._ZN9QDateTime10fromTime_tEjRK9QTimeZone(arg0, arg1)
  case 1:
    // invoke: _ZN9QDateTime10fromTime_tEj
    // invoke: QDateTime fromTime_t(uint)
    var arg0 = C.int32_t(args[0].(int32))
    if false {fmt.Println(arg0)}
    C._ZN9QDateTime10fromTime_tEj(arg0)
  default:
...
func (this *QDateTime) fromMSecsSinceEpoch_s(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = C.int64_t(args[0].(int64))
    if false {fmt.Println(arg0)}
    C._ZN9QDateTime19fromMSecsSinceEpochEx(arg0)
  case 1:
    ...
    var arg1 = args[1].(QTimeZone).qclsinst
    if false {fmt.Println(arg1)}
    C._ZN9QDateTime19fromMSecsSinceEpochExRK9QTimeZone(arg0, arg1)
  default:
...
func (this *QDate) fromString_s(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg1 = args[1].(QString).qclsinst
    if false {fmt.Println(arg1)}
    C._ZN5QDate10fromStringERK7QStringS2_(arg0, arg1)
  default:
...
func (this *QDate) fromJulianDay_s(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = C.int64_t(args[0].(int64))
    if false {fmt.Println(arg0)}
    C._ZN5QDate13fromJulianDayEx(arg0)
  default:
...
func (this *QDate) isLeapYear_s(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = C.int32_t(args[0].(int32))
    if false {fmt.Println(arg0)}
    C._ZN5QDate10isLeapYearEi(arg0)
  default:
...
func NewQDate(args ...interface{}) QDate {
  ...
  case 1:
    ...
    var qthis = unsafe.Pointer(C.malloc(5))
    if false {reflect.TypeOf(qthis)}
    C._ZN5QDateC2Eiii(qthis, arg0, arg1, arg2)
  default:
