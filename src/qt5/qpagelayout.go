...
extern void _ZNK11QPageLayout11orientationEv(void* qthis); // 4
  // proto:  QPageSize QPageLayout::pageSize();
extern void _ZNK11QPageLayout8pageSizeEv(void* qthis); // 4
  // proto:  void QPageLayout::setPageSize(const QPageSize & pageSize, const QMarginsF & minMargins);
extern void _ZN11QPageLayout11setPageSizeERK9QPageSizeRK9QMarginsF(void* qthis, void* arg0, void* arg1); // 4
  // proto:  QRect QPageLayout::paintRectPoints();
extern void _ZNK11QPageLayout15paintRectPointsEv(void* qthis); // 4
  // proto:  QMarginsF QPageLayout::margins();
extern void _ZNK11QPageLayout7marginsEv(void* qthis); // 4
  // proto:  QMarginsF QPageLayout::minimumMargins();
extern void _ZNK11QPageLayout14minimumMarginsEv(void* qthis); // 4
  // proto:  void QPageLayout::setMinimumMargins(const QMarginsF & minMargins);
extern void _ZN11QPageLayout17setMinimumMarginsERK9QMarginsF(void* qthis, void* arg0); // 4
  // proto:  void QPageLayout::QPageLayout(const QPageLayout & other);
extern void _ZN11QPageLayoutC2ERKS_(void* qthis, void* arg0); // 3
  // proto:  void QPageLayout::QPageLayout();
extern void _ZN11QPageLayoutC2Ev(void* qthis); // 3
  // proto:  QRect QPageLayout::fullRectPoints();
extern void _ZNK11QPageLayout14fullRectPointsEv(void* qthis); // 4
  // proto:  QRectF QPageLayout::fullRect();
extern void _ZNK11QPageLayout8fullRectEv(void* qthis); // 4
  // proto:  QMargins QPageLayout::marginsPoints();
extern void _ZNK11QPageLayout13marginsPointsEv(void* qthis); // 4
  // proto:  void QPageLayout::swap(QPageLayout & other);
extern void _ZN11QPageLayout4swapERS_(void* qthis, void* arg0); // 2
  // proto:  void QPageLayout::~QPageLayout();
extern void _ZN11QPageLayoutD2Ev(void* qthis); // 4
  // proto:  QMarginsF QPageLayout::maximumMargins();
extern void _ZNK11QPageLayout14maximumMarginsEv(void* qthis); // 4
  // proto:  QRect QPageLayout::fullRectPixels(int resolution);
extern void _ZNK11QPageLayout14fullRectPixelsEi(void* qthis, int32_t arg0); // 4
  // proto:  bool QPageLayout::setTopMargin(qreal topMargin);
extern void _ZN11QPageLayout12setTopMarginEd(void* qthis, double arg0); // 4
  // proto:  bool QPageLayout::isValid();
extern void _ZNK11QPageLayout7isValidEv(void* qthis); // 4
  // proto:  QPageLayout::Unit QPageLayout::units();
extern void _ZNK11QPageLayout5unitsEv(void* qthis); // 4
  // proto:  QRect QPageLayout::paintRectPixels(int resolution);
extern void _ZNK11QPageLayout15paintRectPixelsEi(void* qthis, int32_t arg0); // 4
  // proto:  QRectF QPageLayout::paintRect();
extern void _ZNK11QPageLayout9paintRectEv(void* qthis); // 4
  // proto:  bool QPageLayout::setLeftMargin(qreal leftMargin);
extern void _ZN11QPageLayout13setLeftMarginEd(void* qthis, double arg0); // 4
  // proto:  bool QPageLayout::setRightMargin(qreal rightMargin);
extern void _ZN11QPageLayout14setRightMarginEd(void* qthis, double arg0); // 4
  // proto:  bool QPageLayout::isEquivalentTo(const QPageLayout & other);
extern void _ZNK11QPageLayout14isEquivalentToERKS_(void* qthis, void* arg0); // 4
  // proto:  QMargins QPageLayout::marginsPixels(int resolution);
extern void _ZNK11QPageLayout13marginsPixelsEi(void* qthis, int32_t arg0); // 4
  // proto:  QPageLayout::Mode QPageLayout::mode();
extern void _ZNK11QPageLayout4modeEv(void* qthis); // 4
  // proto:  bool QPageLayout::setMargins(const QMarginsF & margins);
extern void _ZN11QPageLayout10setMarginsERK9QMarginsF(void* qthis, void* arg0); // 4
  // proto:  bool QPageLayout::setBottomMargin(qreal bottomMargin);
extern void _ZN11QPageLayout15setBottomMarginEd(void* qthis, double arg0); // 4
*/
import "C"
// } // <= ext block end
...
func (this *QPageLayout) orientation(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK11QPageLayout11orientationEv(this.qclsinst)
  default:
...
func NewQPageLayout(args ...interface{}) QPageLayout {
  ...
  case 0:
    ...
    C._ZN11QPageLayoutC2ERKS_(qthis, arg0)
  case 1:
    // invoke: _ZN11QPageLayoutC1Ev
    // invoke: void QPageLayout()
    var qthis = unsafe.Pointer(C.malloc(5))
    if false {reflect.TypeOf(qthis)}
    C._ZN11QPageLayoutC2Ev(qthis)
  default:
...
func (this *QPageLayout) FreeQPageLayout(args ...interface{}) () {
  ...
  case 0:
    ...
    // invoke: void ~QPageLayout()
    C._ZN11QPageLayoutD2Ev(this.qclsinst)
  default:
    qtrt.ErrorResolve("QPageLayout", "~QPageLayout", args)
  }
...
func (this *QPageLayout) units(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK11QPageLayout5unitsEv(this.qclsinst)
  default:
...
func (this *QPageLayout) mode(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK11QPageLayout4modeEv(this.qclsinst)
  default:
