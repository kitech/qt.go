...
extern void _ZNK14QDesktopWidget12screenNumberEPK7QWidget(void* qthis, void* arg0); // 4
  // proto:  int QDesktopWidget::screenNumber(const QPoint & );
extern void _ZNK14QDesktopWidget12screenNumberERK6QPoint(void* qthis, void* arg0); // 4
  // proto:  int QDesktopWidget::screenCount();
extern void _ZNK14QDesktopWidget11screenCountEv(void* qthis); // 2
  // proto:  const QRect QDesktopWidget::availableGeometry(int screen);
extern void _ZNK14QDesktopWidget17availableGeometryEi(void* qthis, int32_t arg0); // 4
  // proto:  const QRect QDesktopWidget::availableGeometry(const QWidget * widget);
extern void _ZNK14QDesktopWidget17availableGeometryEPK7QWidget(void* qthis, void* arg0); // 4
  // proto:  const QRect QDesktopWidget::availableGeometry(const QPoint & point);
extern void _ZNK14QDesktopWidget17availableGeometryERK6QPoint(void* qthis, void* arg0); // 2
  // proto:  const QRect QDesktopWidget::screenGeometry(const QPoint & point);
extern void _ZNK14QDesktopWidget14screenGeometryERK6QPoint(void* qthis, void* arg0); // 2
  // proto:  const QRect QDesktopWidget::screenGeometry(int screen);
extern void _ZNK14QDesktopWidget14screenGeometryEi(void* qthis, int32_t arg0); // 4
  // proto:  const QRect QDesktopWidget::screenGeometry(const QWidget * widget);
extern void _ZNK14QDesktopWidget14screenGeometryEPK7QWidget(void* qthis, void* arg0); // 4
  // proto:  bool QDesktopWidget::isVirtualDesktop();
extern void _ZNK14QDesktopWidget16isVirtualDesktopEv(void* qthis); // 4
  // proto:  QWidget * QDesktopWidget::screen(int screen);
extern void _ZN14QDesktopWidget6screenEi(void* qthis, int32_t arg0); // 4
  // proto:  int QDesktopWidget::primaryScreen();
extern void _ZNK14QDesktopWidget13primaryScreenEv(void* qthis); // 4
  // proto:  int QDesktopWidget::numScreens();
extern void _ZNK14QDesktopWidget10numScreensEv(void* qthis); // 4
  // proto:  void QDesktopWidget::QDesktopWidget();
extern void _ZN14QDesktopWidgetC2Ev(void* qthis); // 3
  // proto:  const QMetaObject * QDesktopWidget::metaObject();
extern void _ZNK14QDesktopWidget10metaObjectEv(void* qthis); // 4
  // proto:  void QDesktopWidget::~QDesktopWidget();
extern void _ZN14QDesktopWidgetD2Ev(void* qthis); // 4
*/
import "C"
// } // <= ext block end
...
func (this *QDesktopWidget) screenCount(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK14QDesktopWidget11screenCountEv(this.qclsinst)
  default:
...
func NewQDesktopWidget(args ...interface{}) QDesktopWidget {
  ...
  case 0:
    ...
    C._ZN14QDesktopWidgetC2Ev(qthis)
  default:
...
func (this *QDesktopWidget) FreeQDesktopWidget(args ...interface{}) () {
  ...
  case 0:
    ...
    // invoke: void ~QDesktopWidget()
    C._ZN14QDesktopWidgetD2Ev(this.qclsinst)
  default:
    qtrt.ErrorResolve("QDesktopWidget", "~QDesktopWidget", args)
  }
