...
extern void _ZNK22QGraphicsItemAnimation15verticalScaleAtEd(void* qthis, double arg0); // 4
  // proto:  qreal QGraphicsItemAnimation::horizontalScaleAt(qreal step);
extern void _ZNK22QGraphicsItemAnimation17horizontalScaleAtEd(void* qthis, double arg0); // 4
  // proto:  void QGraphicsItemAnimation::setShearAt(qreal step, qreal sh, qreal sv);
extern void _ZN22QGraphicsItemAnimation10setShearAtEddd(void* qthis, double arg0, double arg1, double arg2); // 4
  // proto:  QList<QPair<qreal, QPointF> > QGraphicsItemAnimation::posList();
extern void _ZNK22QGraphicsItemAnimation7posListEv(void* qthis); // 4
  // proto:  QList<QPair<qreal, QPointF> > QGraphicsItemAnimation::translationList();
extern void _ZNK22QGraphicsItemAnimation15translationListEv(void* qthis); // 4
  // proto:  void QGraphicsItemAnimation::QGraphicsItemAnimation(QObject * parent);
extern void _ZN22QGraphicsItemAnimationC2EP7QObject(void* qthis, void* arg0); // 3
  // proto:  qreal QGraphicsItemAnimation::rotationAt(qreal step);
extern void _ZNK22QGraphicsItemAnimation10rotationAtEd(void* qthis, double arg0); // 4
  // proto:  void QGraphicsItemAnimation::setPosAt(qreal step, const QPointF & pos);
extern void _ZN22QGraphicsItemAnimation8setPosAtEdRK7QPointF(void* qthis, double arg0, void* arg1); // 4
  // proto:  QList<QPair<qreal, QPointF> > QGraphicsItemAnimation::scaleList();
extern void _ZNK22QGraphicsItemAnimation9scaleListEv(void* qthis); // 4
  // proto:  QTimeLine * QGraphicsItemAnimation::timeLine();
extern void _ZNK22QGraphicsItemAnimation8timeLineEv(void* qthis); // 4
  // proto:  qreal QGraphicsItemAnimation::yTranslationAt(qreal step);
extern void _ZNK22QGraphicsItemAnimation14yTranslationAtEd(void* qthis, double arg0); // 4
  // proto:  void QGraphicsItemAnimation::setStep(qreal x);
extern void _ZN22QGraphicsItemAnimation7setStepEd(void* qthis, double arg0); // 4
  // proto:  qreal QGraphicsItemAnimation::xTranslationAt(qreal step);
extern void _ZNK22QGraphicsItemAnimation14xTranslationAtEd(void* qthis, double arg0); // 4
  // proto:  void QGraphicsItemAnimation::setRotationAt(qreal step, qreal angle);
extern void _ZN22QGraphicsItemAnimation13setRotationAtEdd(void* qthis, double arg0, double arg1); // 4
  // proto:  void QGraphicsItemAnimation::setTimeLine(QTimeLine * timeLine);
extern void _ZN22QGraphicsItemAnimation11setTimeLineEP9QTimeLine(void* qthis, void* arg0); // 4
  // proto:  QMatrix QGraphicsItemAnimation::matrixAt(qreal step);
extern void _ZNK22QGraphicsItemAnimation8matrixAtEd(void* qthis, double arg0); // 4
  // proto:  qreal QGraphicsItemAnimation::horizontalShearAt(qreal step);
extern void _ZNK22QGraphicsItemAnimation17horizontalShearAtEd(void* qthis, double arg0); // 4
  // proto:  QList<QPair<qreal, QPointF> > QGraphicsItemAnimation::shearList();
extern void _ZNK22QGraphicsItemAnimation9shearListEv(void* qthis); // 4
  // proto:  void QGraphicsItemAnimation::setScaleAt(qreal step, qreal sx, qreal sy);
extern void _ZN22QGraphicsItemAnimation10setScaleAtEddd(void* qthis, double arg0, double arg1, double arg2); // 4
  // proto:  QList<QPair<qreal, qreal> > QGraphicsItemAnimation::rotationList();
extern void _ZNK22QGraphicsItemAnimation12rotationListEv(void* qthis); // 4
  // proto:  void QGraphicsItemAnimation::setTranslationAt(qreal step, qreal dx, qreal dy);
extern void _ZN22QGraphicsItemAnimation16setTranslationAtEddd(void* qthis, double arg0, double arg1, double arg2); // 4
  // proto:  void QGraphicsItemAnimation::reset();
extern void _ZN22QGraphicsItemAnimation5resetEv(void* qthis); // 4
  // proto:  const QMetaObject * QGraphicsItemAnimation::metaObject();
extern void _ZNK22QGraphicsItemAnimation10metaObjectEv(void* qthis); // 4
  // proto:  void QGraphicsItemAnimation::clear();
extern void _ZN22QGraphicsItemAnimation5clearEv(void* qthis); // 4
  // proto:  void QGraphicsItemAnimation::setItem(QGraphicsItem * item);
extern void _ZN22QGraphicsItemAnimation7setItemEP13QGraphicsItem(void* qthis, void* arg0); // 4
  // proto:  void QGraphicsItemAnimation::~QGraphicsItemAnimation();
extern void _ZN22QGraphicsItemAnimationD2Ev(void* qthis); // 4
  // proto:  QPointF QGraphicsItemAnimation::posAt(qreal step);
extern void _ZNK22QGraphicsItemAnimation5posAtEd(void* qthis, double arg0); // 4
  // proto:  QGraphicsItem * QGraphicsItemAnimation::item();
extern void _ZNK22QGraphicsItemAnimation4itemEv(void* qthis); // 4
  // proto:  qreal QGraphicsItemAnimation::verticalShearAt(qreal step);
extern void _ZNK22QGraphicsItemAnimation15verticalShearAtEd(void* qthis, double arg0); // 4
*/
import "C"
// } // <= ext block end
...
func NewQGraphicsItemAnimation(args ...interface{}) QGraphicsItemAnimation {
  ...
  case 0:
    ...
    C._ZN22QGraphicsItemAnimationC2EP7QObject(qthis, arg0)
  default:
...
func (this *QGraphicsItemAnimation) FreeQGraphicsItemAnimation(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZN22QGraphicsItemAnimationD2Ev(this.qclsinst)
  default:
    qtrt.ErrorResolve("QGraphicsItemAnimation", "~QGraphicsItemAnimation", args)
  }
