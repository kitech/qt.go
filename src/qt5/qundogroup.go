...
func (this *QUndoGroup) createUndoAction(args ...interface{}) () {
  ...
  case 0:
    ...
    var ret = C.C_ZNK10QUndoGroup16createUndoActionEP7QObjectRK7QString(this.qclsinst, arg0, arg1)
...
func (this *QUndoGroup) isClean(args ...interface{}) () {
  ...
  case 0:
    ...
    // invoke: bool isClean()
    var ret = C.C_ZNK10QUndoGroup7isCleanEv(this.qclsinst)
    if false {reflect.TypeOf(ret)}
  default:
...
func (this *QUndoGroup) canUndo(args ...interface{}) () {
  ...
  case 0:
    ...
    // invoke: bool canUndo()
    var ret = C.C_ZNK10QUndoGroup7canUndoEv(this.qclsinst)
    if false {reflect.TypeOf(ret)}
  default:
...
func (this *QUndoGroup) redoText(args ...interface{}) () {
  ...
  case 0:
    ...
    var ret = C.C_ZNK10QUndoGroup8redoTextEv(this.qclsinst)
    if false {reflect.TypeOf(ret)}
  default:
...
func (this *QUndoGroup) canRedo(args ...interface{}) () {
  ...
  case 0:
    ...
    // invoke: bool canRedo()
    var ret = C.C_ZNK10QUndoGroup7canRedoEv(this.qclsinst)
    if false {reflect.TypeOf(ret)}
  default:
...
func (this *QUndoGroup) createRedoAction(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg1 = args[1].(QString).qclsinst
    if false {fmt.Println(arg1)}
    var ret = C.C_ZNK10QUndoGroup16createRedoActionEP7QObjectRK7QString(this.qclsinst, arg0, arg1)
    if false {reflect.TypeOf(ret)}
  default:
...
func (this *QUndoGroup) undoText(args ...interface{}) () {
  ...
  case 0:
    ...
    var ret = C.C_ZNK10QUndoGroup8undoTextEv(this.qclsinst)
    if false {reflect.TypeOf(ret)}
  default:
...
func (this *QUndoGroup) activeStack(args ...interface{}) () {
  ...
  case 0:
    ...
    var ret = C.C_ZNK10QUndoGroup11activeStackEv(this.qclsinst)
    if false {reflect.TypeOf(ret)}
  default:
