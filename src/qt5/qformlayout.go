...
extern void _ZN11QFormLayout10invalidateEv(void* qthis); // 4
  // proto:  void QFormLayout::addItem(QLayoutItem * item);
extern void _ZN11QFormLayout7addItemEP11QLayoutItem(void* qthis, void* arg0); // 4
  // proto:  int QFormLayout::verticalSpacing();
extern void _ZNK11QFormLayout15verticalSpacingEv(void* qthis); // 4
  // proto:  Qt::Orientations QFormLayout::expandingDirections();
extern void _ZNK11QFormLayout19expandingDirectionsEv(void* qthis); // 4
  // proto:  void QFormLayout::QFormLayout(QWidget * parent);
extern void _ZN11QFormLayoutC2EP7QWidget(void* qthis, void* arg0); // 3
  // proto:  Qt::Alignment QFormLayout::formAlignment();
extern void _ZNK11QFormLayout13formAlignmentEv(void* qthis); // 4
  // proto:  QWidget * QFormLayout::labelForField(QLayout * field);
extern void _ZNK11QFormLayout13labelForFieldEP7QLayout(void* qthis, void* arg0); // 4
  // proto:  QWidget * QFormLayout::labelForField(QWidget * field);
extern void _ZNK11QFormLayout13labelForFieldEP7QWidget(void* qthis, void* arg0); // 4
  // proto:  void QFormLayout::~QFormLayout();
extern void _ZN11QFormLayoutD2Ev(void* qthis); // 4
  // proto:  QFormLayout::FieldGrowthPolicy QFormLayout::fieldGrowthPolicy();
extern void _ZNK11QFormLayout17fieldGrowthPolicyEv(void* qthis); // 4
  // proto:  void QFormLayout::setVerticalSpacing(int spacing);
extern void _ZN11QFormLayout18setVerticalSpacingEi(void* qthis, int32_t arg0); // 4
  // proto:  QLayoutItem * QFormLayout::takeAt(int index);
extern void _ZN11QFormLayout6takeAtEi(void* qthis, int32_t arg0); // 4
  // proto:  void QFormLayout::setSpacing(int );
extern void _ZN11QFormLayout10setSpacingEi(void* qthis, int32_t arg0); // 4
  // proto:  int QFormLayout::horizontalSpacing();
extern void _ZNK11QFormLayout17horizontalSpacingEv(void* qthis); // 4
  // proto:  void QFormLayout::setGeometry(const QRect & rect);
extern void _ZN11QFormLayout11setGeometryERK5QRect(void* qthis, void* arg0); // 4
  // proto:  int QFormLayout::spacing();
extern void _ZNK11QFormLayout7spacingEv(void* qthis); // 4
  // proto:  int QFormLayout::rowCount();
extern void _ZNK11QFormLayout8rowCountEv(void* qthis); // 4
  // proto:  QFormLayout::RowWrapPolicy QFormLayout::rowWrapPolicy();
extern void _ZNK11QFormLayout13rowWrapPolicyEv(void* qthis); // 4
  // proto:  QSize QFormLayout::sizeHint();
extern void _ZNK11QFormLayout8sizeHintEv(void* qthis); // 4
  // proto:  int QFormLayout::heightForWidth(int width);
extern void _ZNK11QFormLayout14heightForWidthEi(void* qthis, int32_t arg0); // 4
  // proto:  int QFormLayout::count();
extern void _ZNK11QFormLayout5countEv(void* qthis); // 4
  // proto:  const QMetaObject * QFormLayout::metaObject();
extern void _ZNK11QFormLayout10metaObjectEv(void* qthis); // 4
  // proto:  bool QFormLayout::hasHeightForWidth();
extern void _ZNK11QFormLayout17hasHeightForWidthEv(void* qthis); // 4
  // proto:  QLayoutItem * QFormLayout::itemAt(int index);
extern void _ZNK11QFormLayout6itemAtEi(void* qthis, int32_t arg0); // 4
  // proto:  QSize QFormLayout::minimumSize();
extern void _ZNK11QFormLayout11minimumSizeEv(void* qthis); // 4
  // proto:  void QFormLayout::setHorizontalSpacing(int spacing);
extern void _ZN11QFormLayout20setHorizontalSpacingEi(void* qthis, int32_t arg0); // 4
  // proto:  void QFormLayout::insertRow(int row, QWidget * label, QWidget * field);
extern void _ZN11QFormLayout9insertRowEiP7QWidgetS1_(void* qthis, int32_t arg0, void* arg1, void* arg2); // 4
  // proto:  void QFormLayout::insertRow(int row, QLayout * layout);
extern void _ZN11QFormLayout9insertRowEiP7QLayout(void* qthis, int32_t arg0, void* arg1); // 4
  // proto:  void QFormLayout::insertRow(int row, const QString & labelText, QLayout * field);
extern void _ZN11QFormLayout9insertRowEiRK7QStringP7QLayout(void* qthis, int32_t arg0, void* arg1, void* arg2); // 4
  // proto:  void QFormLayout::insertRow(int row, QWidget * label, QLayout * field);
extern void _ZN11QFormLayout9insertRowEiP7QWidgetP7QLayout(void* qthis, int32_t arg0, void* arg1, void* arg2); // 4
  // proto:  void QFormLayout::insertRow(int row, const QString & labelText, QWidget * field);
extern void _ZN11QFormLayout9insertRowEiRK7QStringP7QWidget(void* qthis, int32_t arg0, void* arg1, void* arg2); // 4
  // proto:  void QFormLayout::insertRow(int row, QWidget * widget);
extern void _ZN11QFormLayout9insertRowEiP7QWidget(void* qthis, int32_t arg0, void* arg1); // 4
  // proto:  void QFormLayout::addRow(QWidget * label, QLayout * field);
extern void _ZN11QFormLayout6addRowEP7QWidgetP7QLayout(void* qthis, void* arg0, void* arg1); // 4
  // proto:  void QFormLayout::addRow(QLayout * layout);
extern void _ZN11QFormLayout6addRowEP7QLayout(void* qthis, void* arg0); // 4
  // proto:  void QFormLayout::addRow(QWidget * widget);
extern void _ZN11QFormLayout6addRowEP7QWidget(void* qthis, void* arg0); // 4
  // proto:  void QFormLayout::addRow(const QString & labelText, QLayout * field);
extern void _ZN11QFormLayout6addRowERK7QStringP7QLayout(void* qthis, void* arg0, void* arg1); // 4
  // proto:  void QFormLayout::addRow(const QString & labelText, QWidget * field);
extern void _ZN11QFormLayout6addRowERK7QStringP7QWidget(void* qthis, void* arg0, void* arg1); // 4
  // proto:  void QFormLayout::addRow(QWidget * label, QWidget * field);
extern void _ZN11QFormLayout6addRowEP7QWidgetS1_(void* qthis, void* arg0, void* arg1); // 4
  // proto:  Qt::Alignment QFormLayout::labelAlignment();
extern void _ZNK11QFormLayout14labelAlignmentEv(void* qthis); // 4
*/
import "C"
// } // <= ext block end
...
func (this *QFormLayout) expandingDirections(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK11QFormLayout19expandingDirectionsEv(this.qclsinst)
  default:
...
func NewQFormLayout(args ...interface{}) QFormLayout {
  ...
  case 0:
    ...
    C._ZN11QFormLayoutC2EP7QWidget(qthis, arg0)
  default:
...
func (this *QFormLayout) formAlignment(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK11QFormLayout13formAlignmentEv(this.qclsinst)
  default:
...
func (this *QFormLayout) FreeQFormLayout(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZN11QFormLayoutD2Ev(this.qclsinst)
  default:
    qtrt.ErrorResolve("QFormLayout", "~QFormLayout", args)
  }
...
func (this *QFormLayout) fieldGrowthPolicy(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK11QFormLayout17fieldGrowthPolicyEv(this.qclsinst)
  default:
...
func (this *QFormLayout) rowWrapPolicy(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK11QFormLayout13rowWrapPolicyEv(this.qclsinst)
  default:
...
func (this *QFormLayout) labelAlignment(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK11QFormLayout14labelAlignmentEv(this.qclsinst)
  default:
