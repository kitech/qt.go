...
extern void _ZNK10QUndoStack16createUndoActionEP7QObjectRK7QString(void* qthis, void* arg0, void* arg1); // 4
  // proto:  void QUndoStack::setActive(bool active);
extern void _ZN10QUndoStack9setActiveEb(void* qthis, bool arg0); // 4
  // proto:  void QUndoStack::setIndex(int idx);
extern void _ZN10QUndoStack8setIndexEi(void* qthis, int32_t arg0); // 4
  // proto:  void QUndoStack::redo();
extern void _ZN10QUndoStack4redoEv(void* qthis); // 4
  // proto:  bool QUndoStack::canUndo();
extern void _ZNK10QUndoStack7canUndoEv(void* qthis); // 4
  // proto:  bool QUndoStack::isClean();
extern void _ZNK10QUndoStack7isCleanEv(void* qthis); // 4
  // proto:  int QUndoStack::cleanIndex();
extern void _ZNK10QUndoStack10cleanIndexEv(void* qthis); // 4
  // proto:  void QUndoStack::QUndoStack(QObject * parent);
extern void _ZN10QUndoStackC2EP7QObject(void* qthis, void* arg0); // 3
  // proto:  void QUndoStack::~QUndoStack();
extern void _ZN10QUndoStackD2Ev(void* qthis); // 4
  // proto:  QString QUndoStack::text(int idx);
extern void _ZNK10QUndoStack4textEi(void* qthis, int32_t arg0); // 4
  // proto:  QString QUndoStack::redoText();
extern void _ZNK10QUndoStack8redoTextEv(void* qthis); // 4
  // proto:  int QUndoStack::count();
extern void _ZNK10QUndoStack5countEv(void* qthis); // 4
  // proto:  int QUndoStack::index();
extern void _ZNK10QUndoStack5indexEv(void* qthis); // 4
  // proto:  void QUndoStack::beginMacro(const QString & text);
extern void _ZN10QUndoStack10beginMacroERK7QString(void* qthis, void* arg0); // 4
  // proto:  void QUndoStack::undo();
extern void _ZN10QUndoStack4undoEv(void* qthis); // 4
  // proto:  int QUndoStack::undoLimit();
extern void _ZNK10QUndoStack9undoLimitEv(void* qthis); // 4
  // proto:  bool QUndoStack::canRedo();
extern void _ZNK10QUndoStack7canRedoEv(void* qthis); // 4
  // proto:  void QUndoStack::setClean();
extern void _ZN10QUndoStack8setCleanEv(void* qthis); // 4
  // proto:  bool QUndoStack::isActive();
extern void _ZNK10QUndoStack8isActiveEv(void* qthis); // 4
  // proto:  QAction * QUndoStack::createRedoAction(QObject * parent, const QString & prefix);
extern void _ZNK10QUndoStack16createRedoActionEP7QObjectRK7QString(void* qthis, void* arg0, void* arg1); // 4
  // proto:  const QMetaObject * QUndoStack::metaObject();
extern void _ZNK10QUndoStack10metaObjectEv(void* qthis); // 4
  // proto:  QString QUndoStack::undoText();
extern void _ZNK10QUndoStack8undoTextEv(void* qthis); // 4
  // proto:  void QUndoStack::clear();
extern void _ZN10QUndoStack5clearEv(void* qthis); // 4
  // proto:  void QUndoStack::setUndoLimit(int limit);
extern void _ZN10QUndoStack12setUndoLimitEi(void* qthis, int32_t arg0); // 4
  // proto:  const QUndoCommand * QUndoStack::command(int index);
extern void _ZNK10QUndoStack7commandEi(void* qthis, int32_t arg0); // 4
  // proto:  void QUndoStack::endMacro();
extern void _ZN10QUndoStack8endMacroEv(void* qthis); // 4
  // proto:  void QUndoStack::push(QUndoCommand * cmd);
extern void _ZN10QUndoStack4pushEP12QUndoCommand(void* qthis, void* arg0); // 4
  // proto:  QString QUndoCommand::actionText();
extern void _ZNK12QUndoCommand10actionTextEv(void* qthis); // 4
  // proto:  bool QUndoCommand::mergeWith(const QUndoCommand * other);
extern void _ZN12QUndoCommand9mergeWithEPKS_(void* qthis, void* arg0); // 4
  // proto:  QString QUndoCommand::text();
extern void _ZNK12QUndoCommand4textEv(void* qthis); // 4
  // proto:  void QUndoCommand::setText(const QString & text);
extern void _ZN12QUndoCommand7setTextERK7QString(void* qthis, void* arg0); // 4
  // proto:  void QUndoCommand::undo();
extern void _ZN12QUndoCommand4undoEv(void* qthis); // 4
  // proto:  int QUndoCommand::childCount();
extern void _ZNK12QUndoCommand10childCountEv(void* qthis); // 4
  // proto:  void QUndoCommand::QUndoCommand(const QString & text, QUndoCommand * parent);
extern void _ZN12QUndoCommandC2ERK7QStringPS_(void* qthis, void* arg0, void* arg1); // 3
  // proto:  void QUndoCommand::QUndoCommand(QUndoCommand * parent);
extern void _ZN12QUndoCommandC2EPS_(void* qthis, void* arg0); // 3
  // proto:  void QUndoCommand::~QUndoCommand();
extern void _ZN12QUndoCommandD2Ev(void* qthis); // 4
  // proto:  const QUndoCommand * QUndoCommand::child(int index);
extern void _ZNK12QUndoCommand5childEi(void* qthis, int32_t arg0); // 4
  // proto:  void QUndoCommand::redo();
extern void _ZN12QUndoCommand4redoEv(void* qthis); // 4
  // proto:  int QUndoCommand::id();
extern void _ZNK12QUndoCommand2idEv(void* qthis); // 4
*/
import "C"
// } // <= ext block end
...
func (this *QUndoStack) createUndoAction(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK10QUndoStack16createUndoActionEP7QObjectRK7QString(this.qclsinst, arg0, arg1)
  default:
...
func (this *QUndoStack) setIndex(args ...interface{}) () {
  ...
  case 0:
    ...
    if false {fmt.Println(arg0)}
    C._ZN10QUndoStack8setIndexEi(this.qclsinst, arg0)
  default:
...
func (this *QUndoStack) redo(args ...interface{}) () {
  ...
  case 0:
    ...
    // invoke: void redo()
    C._ZN10QUndoStack4redoEv(this.qclsinst)
  default:
...
func (this *QUndoStack) canUndo(args ...interface{}) () {
  ...
  case 0:
    ...
    // invoke: bool canUndo()
    C._ZNK10QUndoStack7canUndoEv(this.qclsinst)
  default:
...
func (this *QUndoStack) isClean(args ...interface{}) () {
  ...
  case 0:
    ...
    // invoke: bool isClean()
    C._ZNK10QUndoStack7isCleanEv(this.qclsinst)
  default:
...
func (this *QUndoStack) cleanIndex(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK10QUndoStack10cleanIndexEv(this.qclsinst)
  default:
...
func NewQUndoStack(args ...interface{}) QUndoStack {
  ...
  case 0:
    ...
    C._ZN10QUndoStackC2EP7QObject(qthis, arg0)
  default:
...
func (this *QUndoStack) FreeQUndoStack(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZN10QUndoStackD2Ev(this.qclsinst)
  default:
    qtrt.ErrorResolve("QUndoStack", "~QUndoStack", args)
  }
...
func (this *QUndoStack) text(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = C.int32_t(args[0].(int32))
    if false {fmt.Println(arg0)}
    C._ZNK10QUndoStack4textEi(this.qclsinst, arg0)
  default:
...
func (this *QUndoStack) redoText(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK10QUndoStack8redoTextEv(this.qclsinst)
  default:
...
func (this *QUndoStack) count(args ...interface{}) () {
  ...
  case 0:
    ...
    // invoke: int count()
    C._ZNK10QUndoStack5countEv(this.qclsinst)
  default:
...
func (this *QUndoStack) index(args ...interface{}) () {
  ...
  case 0:
    ...
    // invoke: int index()
    C._ZNK10QUndoStack5indexEv(this.qclsinst)
  default:
...
func (this *QUndoStack) beginMacro(args ...interface{}) () {
  ...
  case 0:
    ...
    if false {fmt.Println(arg0)}
    C._ZN10QUndoStack10beginMacroERK7QString(this.qclsinst, arg0)
  default:
...
func (this *QUndoStack) undo(args ...interface{}) () {
  ...
  case 0:
    ...
    // invoke: void undo()
    C._ZN10QUndoStack4undoEv(this.qclsinst)
  default:
...
func (this *QUndoStack) undoLimit(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK10QUndoStack9undoLimitEv(this.qclsinst)
  default:
...
func (this *QUndoStack) canRedo(args ...interface{}) () {
  ...
  case 0:
    ...
    // invoke: bool canRedo()
    C._ZNK10QUndoStack7canRedoEv(this.qclsinst)
  default:
...
func (this *QUndoStack) setClean(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZN10QUndoStack8setCleanEv(this.qclsinst)
  default:
...
func (this *QUndoStack) isActive(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK10QUndoStack8isActiveEv(this.qclsinst)
  default:
...
func (this *QUndoStack) createRedoAction(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg1 = args[1].(QString).qclsinst
    if false {fmt.Println(arg1)}
    C._ZNK10QUndoStack16createRedoActionEP7QObjectRK7QString(this.qclsinst, arg0, arg1)
  default:
...
func (this *QUndoStack) metaObject(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK10QUndoStack10metaObjectEv(this.qclsinst)
  default:
...
func (this *QUndoStack) undoText(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK10QUndoStack8undoTextEv(this.qclsinst)
  default:
...
func (this *QUndoStack) clear(args ...interface{}) () {
  ...
  case 0:
    ...
    // invoke: void clear()
    C._ZN10QUndoStack5clearEv(this.qclsinst)
  default:
...
func (this *QUndoStack) setUndoLimit(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = C.int32_t(args[0].(int32))
    if false {fmt.Println(arg0)}
    C._ZN10QUndoStack12setUndoLimitEi(this.qclsinst, arg0)
  default:
...
func (this *QUndoStack) command(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = C.int32_t(args[0].(int32))
    if false {fmt.Println(arg0)}
    C._ZNK10QUndoStack7commandEi(this.qclsinst, arg0)
  default:
...
func (this *QUndoStack) endMacro(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZN10QUndoStack8endMacroEv(this.qclsinst)
  default:
...
func (this *QUndoStack) push(args ...interface{}) () {
  ...
  case 0:
    ...
    if false {fmt.Println(arg0)}
    C._ZN10QUndoStack4pushEP12QUndoCommand(this.qclsinst, arg0)
  default:
...
func (this *QUndoCommand) actionText(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK12QUndoCommand10actionTextEv(this.qclsinst)
  default:
...
func (this *QUndoCommand) mergeWith(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = args[0].(QUndoCommand).qclsinst
    if false {fmt.Println(arg0)}
    C._ZN12QUndoCommand9mergeWithEPKS_(this.qclsinst, arg0)
  default:
...
func (this *QUndoCommand) text(args ...interface{}) () {
  ...
  case 0:
    ...
    // invoke: QString text()
    C._ZNK12QUndoCommand4textEv(this.qclsinst)
  default:
...
func (this *QUndoCommand) setText(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = args[0].(QString).qclsinst
    if false {fmt.Println(arg0)}
    C._ZN12QUndoCommand7setTextERK7QString(this.qclsinst, arg0)
  default:
...
func (this *QUndoCommand) undo(args ...interface{}) () {
  ...
  case 0:
    ...
    // invoke: void undo()
    C._ZN12QUndoCommand4undoEv(this.qclsinst)
  default:
...
func (this *QUndoCommand) childCount(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK12QUndoCommand10childCountEv(this.qclsinst)
  default:
...
func NewQUndoCommand(args ...interface{}) QUndoCommand {
  ...
  case 0:
    ...
    var qthis = unsafe.Pointer(C.malloc(5))
    if false {reflect.TypeOf(qthis)}
    C._ZN12QUndoCommandC2ERK7QStringPS_(qthis, arg0, arg1)
  case 1:
    ...
    var qthis = unsafe.Pointer(C.malloc(5))
    if false {reflect.TypeOf(qthis)}
    C._ZN12QUndoCommandC2EPS_(qthis, arg0)
  default:
...
func (this *QUndoCommand) FreeQUndoCommand(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZN12QUndoCommandD2Ev(this.qclsinst)
  default:
    qtrt.ErrorResolve("QUndoCommand", "~QUndoCommand", args)
  }
...
func (this *QUndoCommand) child(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = C.int32_t(args[0].(int32))
    if false {fmt.Println(arg0)}
    C._ZNK12QUndoCommand5childEi(this.qclsinst, arg0)
  default:
...
func (this *QUndoCommand) redo(args ...interface{}) () {
  ...
  case 0:
    ...
    // invoke: void redo()
    C._ZN12QUndoCommand4redoEv(this.qclsinst)
  default:
...
func (this *QUndoCommand) id(args ...interface{}) () {
  ...
  case 0:
    ...
    // invoke: int id()
    C._ZNK12QUndoCommand2idEv(this.qclsinst)
  default:
