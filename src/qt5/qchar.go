...
extern void _ZN11QLatin1CharC2Ec(void* qthis, unsigned char arg0); // 1
  // proto:  char QLatin1Char::toLatin1();
extern void _ZNK11QLatin1Char8toLatin1Ev(void* qthis); // 2
  // proto:  ushort QLatin1Char::unicode();
extern void _ZNK11QLatin1Char7unicodeEv(void* qthis); // 2
  // proto: static bool QChar::isLetterOrNumber(uint ucs4);
extern void _ZN5QChar16isLetterOrNumberEj(int32_t arg0); // 2
  // proto:  bool QChar::isLetterOrNumber();
extern void _ZNK5QChar16isLetterOrNumberEv(void* qthis); // 2
  // proto:  QChar::UnicodeVersion QChar::unicodeVersion();
extern void _ZNK5QChar14unicodeVersionEv(void* qthis); // 2
  // proto: static QChar::UnicodeVersion QChar::unicodeVersion(uint ucs4);
extern void _ZN5QChar14unicodeVersionEj(int32_t arg0); // 4
  // proto: static bool QChar::hasMirrored(uint ucs4);
extern void _ZN5QChar11hasMirroredEj(int32_t arg0); // 4
  // proto:  bool QChar::hasMirrored();
extern void _ZNK5QChar11hasMirroredEv(void* qthis); // 2
  // proto:  char QChar::toLatin1();
extern void _ZNK5QChar8toLatin1Ev(void* qthis); // 2
  // proto:  bool QChar::isTitleCase();
extern void _ZNK5QChar11isTitleCaseEv(void* qthis); // 2
  // proto: static bool QChar::isTitleCase(uint ucs4);
extern void _ZN5QChar11isTitleCaseEj(int32_t arg0); // 2
  // proto: static QChar::UnicodeVersion QChar::currentUnicodeVersion();
extern void _ZN5QChar21currentUnicodeVersionEv(); // 4
  // proto:  void QChar::setCell(uchar cell);
extern void _ZN5QChar7setCellEh(void* qthis, unsigned char arg0); // 2
  // proto:  ushort & QChar::unicode();
extern void _ZN5QChar7unicodeEv(void* qthis); // 2
  // proto: static ushort QChar::lowSurrogate(uint ucs4);
extern void _ZN5QChar12lowSurrogateEj(int32_t arg0); // 2
  // proto: static bool QChar::isSpace(uint ucs4);
extern void _ZN5QChar7isSpaceEj(int32_t arg0); // 2
  // proto:  bool QChar::isSpace();
extern void _ZNK5QChar7isSpaceEv(void* qthis); // 2
  // proto:  uchar QChar::row();
extern void _ZNK5QChar3rowEv(void* qthis); // 2
  // proto:  QChar::Category QChar::category();
extern void _ZNK5QChar8categoryEv(void* qthis); // 2
  // proto: static QChar::Category QChar::category(uint ucs4);
extern void _ZN5QChar8categoryEj(int32_t arg0); // 4
  // proto:  QChar::Decomposition QChar::decompositionTag();
extern void _ZNK5QChar16decompositionTagEv(void* qthis); // 2
  // proto: static QChar::Decomposition QChar::decompositionTag(uint ucs4);
extern void _ZN5QChar16decompositionTagEj(int32_t arg0); // 4
  // proto:  bool QChar::isHighSurrogate();
extern void _ZNK5QChar15isHighSurrogateEv(void* qthis); // 2
  // proto: static bool QChar::isHighSurrogate(uint ucs4);
extern void _ZN5QChar15isHighSurrogateEj(int32_t arg0); // 2
  // proto: static QChar::Script QChar::script(uint ucs4);
extern void _ZN5QChar6scriptEj(int32_t arg0); // 4
  // proto:  QChar::Script QChar::script();
extern void _ZNK5QChar6scriptEv(void* qthis); // 2
  // proto: static QChar QChar::fromLatin1(char c);
extern void _ZN5QChar10fromLatin1Ec(unsigned char arg0); // 2
  // proto: static QChar::JoiningType QChar::joiningType(uint ucs4);
extern void _ZN5QChar11joiningTypeEj(int32_t arg0); // 4
  // proto:  QChar::JoiningType QChar::joiningType();
extern void _ZNK5QChar11joiningTypeEv(void* qthis); // 2
  // proto:  uchar QChar::cell();
extern void _ZNK5QChar4cellEv(void* qthis); // 2
  // proto:  int QChar::digitValue();
extern void _ZNK5QChar10digitValueEv(void* qthis); // 2
  // proto: static int QChar::digitValue(uint ucs4);
extern void _ZN5QChar10digitValueEj(int32_t arg0); // 4
  // proto: static bool QChar::requiresSurrogates(uint ucs4);
extern void _ZN5QChar18requiresSurrogatesEj(int32_t arg0); // 2
  // proto:  QString QChar::decomposition();
extern void _ZNK5QChar13decompositionEv(void* qthis); // 4
  // proto: static QString QChar::decomposition(uint ucs4);
extern void _ZN5QChar13decompositionEj(int32_t arg0); // 4
  // proto: static ushort QChar::highSurrogate(uint ucs4);
extern void _ZN5QChar13highSurrogateEj(int32_t arg0); // 2
  // proto:  bool QChar::isSurrogate();
extern void _ZNK5QChar11isSurrogateEv(void* qthis); // 2
  // proto: static bool QChar::isSurrogate(uint ucs4);
extern void _ZN5QChar11isSurrogateEj(int32_t arg0); // 2
  // proto: static QChar::Direction QChar::direction(uint ucs4);
extern void _ZN5QChar9directionEj(int32_t arg0); // 4
  // proto:  QChar::Direction QChar::direction();
extern void _ZNK5QChar9directionEv(void* qthis); // 2
  // proto: static uint QChar::mirroredChar(uint ucs4);
extern void _ZN5QChar12mirroredCharEj(int32_t arg0); // 4
  // proto:  QChar QChar::mirroredChar();
extern void _ZNK5QChar12mirroredCharEv(void* qthis); // 2
  // proto:  unsigned char QChar::combiningClass();
extern void _ZNK5QChar14combiningClassEv(void* qthis); // 2
  // proto: static unsigned char QChar::combiningClass(uint ucs4);
extern void _ZN5QChar14combiningClassEj(int32_t arg0); // 4
  // proto: static bool QChar::isMark(uint ucs4);
extern void _ZN5QChar6isMarkEj(int32_t arg0); // 4
  // proto:  bool QChar::isMark();
extern void _ZNK5QChar6isMarkEv(void* qthis); // 2
  // proto: static bool QChar::isLower(uint ucs4);
extern void _ZN5QChar7isLowerEj(int32_t arg0); // 2
  // proto:  bool QChar::isLower();
extern void _ZNK5QChar7isLowerEv(void* qthis); // 2
  // proto: static bool QChar::isNumber(uint ucs4);
extern void _ZN5QChar8isNumberEj(int32_t arg0); // 2
  // proto:  bool QChar::isNumber();
extern void _ZNK5QChar8isNumberEv(void* qthis); // 2
  // proto: static uint QChar::toLower(uint ucs4);
extern void _ZN5QChar7toLowerEj(int32_t arg0); // 4
  // proto:  QChar QChar::toLower();
extern void _ZNK5QChar7toLowerEv(void* qthis); // 2
  // proto:  QChar QChar::toTitleCase();
extern void _ZNK5QChar11toTitleCaseEv(void* qthis); // 2
  // proto: static uint QChar::toTitleCase(uint ucs4);
extern void _ZN5QChar11toTitleCaseEj(int32_t arg0); // 4
  // proto: static bool QChar::isLowSurrogate(uint ucs4);
extern void _ZN5QChar14isLowSurrogateEj(int32_t arg0); // 2
  // proto:  bool QChar::isLowSurrogate();
extern void _ZNK5QChar14isLowSurrogateEv(void* qthis); // 2
  // proto:  bool QChar::isUpper();
extern void _ZNK5QChar7isUpperEv(void* qthis); // 2
  // proto: static bool QChar::isUpper(uint ucs4);
extern void _ZN5QChar7isUpperEj(int32_t arg0); // 2
  // proto:  void QChar::QChar(char c);
extern void _ZN5QCharC2Ec(void* qthis, unsigned char arg0); // 1
  // proto:  void QChar::QChar(uint rc);
extern void _ZN5QCharC2Ej(void* qthis, int32_t arg0); // 1
  // proto:  void QChar::QChar(int rc);
extern void _ZN5QCharC2Ei(void* qthis, int32_t arg0); // 1
  // proto:  void QChar::QChar(uchar c);
extern void _ZN5QCharC2Eh(void* qthis, unsigned char arg0); // 1
  // proto:  void QChar::QChar(short rc);
extern void _ZN5QCharC2Es(void* qthis, int16_t arg0); // 1
  // proto:  void QChar::QChar(uchar c, uchar r);
extern void _ZN5QCharC2Ehh(void* qthis, unsigned char arg0, unsigned char arg1); // 1
  // proto:  void QChar::QChar();
extern void _ZN5QCharC2Ev(void* qthis); // 1
  // proto:  void QChar::QChar(ushort rc);
extern void _ZN5QCharC2Et(void* qthis, int16_t arg0); // 1
  // proto: static uint QChar::toCaseFolded(uint ucs4);
extern void _ZN5QChar12toCaseFoldedEj(int32_t arg0); // 4
  // proto:  QChar QChar::toCaseFolded();
extern void _ZNK5QChar12toCaseFoldedEv(void* qthis); // 2
  // proto:  bool QChar::isLetter();
extern void _ZNK5QChar8isLetterEv(void* qthis); // 2
  // proto: static bool QChar::isLetter(uint ucs4);
extern void _ZN5QChar8isLetterEj(int32_t arg0); // 2
  // proto: static bool QChar::isNonCharacter(uint ucs4);
extern void _ZN5QChar14isNonCharacterEj(int32_t arg0); // 2
  // proto:  bool QChar::isNonCharacter();
extern void _ZNK5QChar14isNonCharacterEv(void* qthis); // 2
  // proto:  bool QChar::isNull();
extern void _ZNK5QChar6isNullEv(void* qthis); // 2
  // proto:  bool QChar::isPrint();
extern void _ZNK5QChar7isPrintEv(void* qthis); // 2
  // proto: static bool QChar::isPrint(uint ucs4);
extern void _ZN5QChar7isPrintEj(int32_t arg0); // 4
  // proto:  QChar QChar::toUpper();
extern void _ZNK5QChar7toUpperEv(void* qthis); // 2
  // proto: static uint QChar::toUpper(uint ucs4);
extern void _ZN5QChar7toUpperEj(int32_t arg0); // 4
  // proto: static uint QChar::surrogateToUcs4(ushort high, ushort low);
extern void _ZN5QChar15surrogateToUcs4Ett(int16_t arg0, int16_t arg1); // 2
  // proto: static uint QChar::surrogateToUcs4(QChar high, QChar low);
extern void _ZN5QChar15surrogateToUcs4ES_S_(void* arg0, void* arg1); // 2
  // proto: static bool QChar::isDigit(uint ucs4);
extern void _ZN5QChar7isDigitEj(int32_t arg0); // 2
  // proto:  bool QChar::isDigit();
extern void _ZNK5QChar7isDigitEv(void* qthis); // 2
  // proto:  void QChar::setRow(uchar row);
extern void _ZN5QChar6setRowEh(void* qthis, unsigned char arg0); // 2
  // proto:  bool QChar::isPunct();
extern void _ZNK5QChar7isPunctEv(void* qthis); // 2
  // proto: static bool QChar::isPunct(uint ucs4);
extern void _ZN5QChar7isPunctEj(int32_t arg0); // 4
  // proto: static bool QChar::isSymbol(uint ucs4);
extern void _ZN5QChar8isSymbolEj(int32_t arg0); // 4
  // proto:  bool QChar::isSymbol();
extern void _ZNK5QChar8isSymbolEv(void* qthis); // 2
  // proto:  QChar::Joining QChar::joining();
extern void _ZNK5QChar7joiningEv(void* qthis); // 2
  // proto: static QChar::Joining QChar::joining(uint ucs4);
extern void _ZN5QChar7joiningEj(int32_t arg0); // 4
*/
import "C"
// } // <= ext block end
...
func NewQLatin1Char(args ...interface{}) QLatin1Char {
  ...
  case 0:
    ...
    C._ZN11QLatin1CharC2Ec(qthis, arg0)
  default:
...
func (this *QChar) isLetterOrNumber_s(args ...interface{}) () {
  ...
  case 0:
    ...
    if false {fmt.Println(arg0)}
    C._ZN5QChar16isLetterOrNumberEj(arg0)
  case 1:
...
func (this *QChar) hasMirrored_s(args ...interface{}) () {
  ...
  case 1:
    ...
    C._ZNK5QChar11hasMirroredEv(this.qclsinst)
  default:
...
func (this *QChar) isTitleCase(args ...interface{}) () {
  ...
  case 1:
    ...
    var arg0 = C.int32_t(args[0].(int32))
    if false {fmt.Println(arg0)}
    C._ZN5QChar11isTitleCaseEj(arg0)
  default:
...
func (this *QChar) currentUnicodeVersion_s(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZN5QChar21currentUnicodeVersionEv()
  default:
...
func (this *QChar) setCell(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = C.uchar(args[0].(byte))
    if false {fmt.Println(arg0)}
    C._ZN5QChar7setCellEh(this.qclsinst, arg0)
  default:
...
func (this *QChar) unicode(args ...interface{}) () {
  ...
  case 0:
    ...
    // invoke: ushort & unicode()
    C._ZN5QChar7unicodeEv(this.qclsinst)
  default:
...
func (this *QChar) lowSurrogate_s(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = C.int32_t(args[0].(int32))
    if false {fmt.Println(arg0)}
    C._ZN5QChar12lowSurrogateEj(arg0)
  default:
...
func (this *QChar) category(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK5QChar8categoryEv(this.qclsinst)
  case 1:
    // invoke: _ZN5QChar8categoryEj
    // invoke: QChar::Category category(uint)
    var arg0 = C.int32_t(args[0].(int32))
    if false {fmt.Println(arg0)}
    C._ZN5QChar8categoryEj(arg0)
  default:
...
func (this *QChar) isHighSurrogate(args ...interface{}) () {
  ...
  case 1:
    ...
    var arg0 = C.int32_t(args[0].(int32))
    if false {fmt.Println(arg0)}
    C._ZN5QChar15isHighSurrogateEj(arg0)
  default:
...
func (this *QChar) script_s(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = C.int32_t(args[0].(int32))
    if false {fmt.Println(arg0)}
    C._ZN5QChar6scriptEj(arg0)
  case 1:
    // invoke: _ZNK5QChar6scriptEv
    // invoke: QChar::Script script()
    C._ZNK5QChar6scriptEv(this.qclsinst)
  default:
...
func (this *QChar) fromLatin1_s(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = C.uchar(args[0].(byte))
    if false {fmt.Println(arg0)}
    C._ZN5QChar10fromLatin1Ec(arg0)
  default:
...
func (this *QChar) joiningType_s(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = C.int32_t(args[0].(int32))
    if false {fmt.Println(arg0)}
    C._ZN5QChar11joiningTypeEj(arg0)
  case 1:
    // invoke: _ZNK5QChar11joiningTypeEv
    // invoke: QChar::JoiningType joiningType()
    C._ZNK5QChar11joiningTypeEv(this.qclsinst)
  default:
...
func (this *QChar) digitValue(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK5QChar10digitValueEv(this.qclsinst)
  case 1:
...
func (this *QChar) requiresSurrogates_s(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = C.int32_t(args[0].(int32))
    if false {fmt.Println(arg0)}
    C._ZN5QChar18requiresSurrogatesEj(arg0)
  default:
...
func (this *QChar) highSurrogate_s(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = C.int32_t(args[0].(int32))
    if false {fmt.Println(arg0)}
    C._ZN5QChar13highSurrogateEj(arg0)
  default:
...
func (this *QChar) isSurrogate(args ...interface{}) () {
  ...
  case 1:
    ...
    var arg0 = C.int32_t(args[0].(int32))
    if false {fmt.Println(arg0)}
    C._ZN5QChar11isSurrogateEj(arg0)
  default:
...
func (this *QChar) direction_s(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = C.int32_t(args[0].(int32))
    if false {fmt.Println(arg0)}
    C._ZN5QChar9directionEj(arg0)
  case 1:
    // invoke: _ZNK5QChar9directionEv
    // invoke: QChar::Direction direction()
    C._ZNK5QChar9directionEv(this.qclsinst)
  default:
...
func (this *QChar) mirroredChar_s(args ...interface{}) () {
  ...
  case 1:
    ...
    C._ZNK5QChar12mirroredCharEv(this.qclsinst)
  default:
...
func (this *QChar) combiningClass(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK5QChar14combiningClassEv(this.qclsinst)
  case 1:
...
func (this *QChar) isMark_s(args ...interface{}) () {
  ...
  case 1:
    ...
    // invoke: bool isMark()
    C._ZNK5QChar6isMarkEv(this.qclsinst)
  default:
...
func (this *QChar) toLower_s(args ...interface{}) () {
  ...
  case 1:
    ...
    C._ZNK5QChar7toLowerEv(this.qclsinst)
  default:
...
func (this *QChar) toTitleCase(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK5QChar11toTitleCaseEv(this.qclsinst)
  case 1:
...
func (this *QChar) isLowSurrogate_s(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = C.int32_t(args[0].(int32))
    if false {fmt.Println(arg0)}
    C._ZN5QChar14isLowSurrogateEj(arg0)
  case 1:
...
func NewQChar(args ...interface{}) QChar {
  ...
  case 5:
    ...
    var qthis = unsafe.Pointer(C.malloc(5))
    if false {reflect.TypeOf(qthis)}
    C._ZN5QCharC2Ehh(qthis, arg0, arg1)
  case 6:
    // invoke: _ZN5QCharC1Ev
    // invoke: void QChar()
    var qthis = unsafe.Pointer(C.malloc(5))
    if false {reflect.TypeOf(qthis)}
    C._ZN5QCharC2Ev(qthis)
  case 7:
...
func (this *QChar) toCaseFolded_s(args ...interface{}) () {
  ...
  case 1:
    ...
    C._ZNK5QChar12toCaseFoldedEv(this.qclsinst)
  default:
...
func (this *QChar) isNonCharacter_s(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = C.int32_t(args[0].(int32))
    if false {fmt.Println(arg0)}
    C._ZN5QChar14isNonCharacterEj(arg0)
  case 1:
...
func (this *QChar) isPrint(args ...interface{}) () {
  ...
  case 0:
    ...
    // invoke: bool isPrint()
    C._ZNK5QChar7isPrintEv(this.qclsinst)
  case 1:
...
func (this *QChar) toUpper(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK5QChar7toUpperEv(this.qclsinst)
  case 1:
...
func (this *QChar) surrogateToUcs4_s(args ...interface{}) () {
  ...
  case 0:
    ...
    if false {fmt.Println(arg1)}
    C._ZN5QChar15surrogateToUcs4Ett(arg0, arg1)
  case 1:
    ...
    if false {fmt.Println(arg1)}
    C._ZN5QChar15surrogateToUcs4ES_S_(arg0, arg1)
  default:
...
func (this *QChar) setRow(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = C.uchar(args[0].(byte))
    if false {fmt.Println(arg0)}
    C._ZN5QChar6setRowEh(this.qclsinst, arg0)
  default:
...
func (this *QChar) isPunct(args ...interface{}) () {
  ...
  case 0:
    ...
    // invoke: bool isPunct()
    C._ZNK5QChar7isPunctEv(this.qclsinst)
  case 1:
...
func (this *QChar) isSymbol_s(args ...interface{}) () {
  ...
  case 1:
    ...
    C._ZNK5QChar8isSymbolEv(this.qclsinst)
  default:
...
func (this *QChar) joining(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK5QChar7joiningEv(this.qclsinst)
  case 1:
    // invoke: _ZN5QChar7joiningEj
    // invoke: QChar::Joining joining(uint)
    var arg0 = C.int32_t(args[0].(int32))
    if false {fmt.Println(arg0)}
    C._ZN5QChar7joiningEj(arg0)
  default:
