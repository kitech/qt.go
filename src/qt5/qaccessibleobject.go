...
func (this *QAccessibleApplication) parent(args ...interface{}) () {
  ...
  case 0:
    ...
    var ret = C.C_ZNK22QAccessibleApplication6parentEv(this.qclsinst)
...
func (this *QAccessibleApplication) indexOfChild(args ...interface{}) () {
  ...
  case 0:
    ...
    var ret = C.C_ZNK22QAccessibleApplication12indexOfChildEPK20QAccessibleInterface(this.qclsinst, arg0)
    if false {reflect.TypeOf(ret)}
  default:
...
func (this *QAccessibleApplication) focusChild(args ...interface{}) () {
  ...
  case 0:
    ...
    var ret = C.C_ZNK22QAccessibleApplication10focusChildEv(this.qclsinst)
    if false {reflect.TypeOf(ret)}
  default:
...
func (this *QAccessibleApplication) window(args ...interface{}) () {
  ...
  case 0:
    ...
    var ret = C.C_ZNK22QAccessibleApplication6windowEv(this.qclsinst)
    if false {reflect.TypeOf(ret)}
  default:
...
func (this *QAccessibleApplication) child(args ...interface{}) () {
  ...
  case 0:
    ...
    if false {fmt.Println(arg0)}
    var ret = C.C_ZNK22QAccessibleApplication5childEi(this.qclsinst, arg0)
    if false {reflect.TypeOf(ret)}
  default:
...
func (this *QAccessibleApplication) childCount(args ...interface{}) () {
  ...
  case 0:
    ...
    var ret = C.C_ZNK22QAccessibleApplication10childCountEv(this.qclsinst)
    if false {reflect.TypeOf(ret)}
  default:
...
func (this *QAccessibleObject) object(args ...interface{}) () {
  ...
  case 0:
    ...
    var ret = C.C_ZNK17QAccessibleObject6objectEv(this.qclsinst)
    if false {reflect.TypeOf(ret)}
  default:
...
func (this *QAccessibleObject) isValid(args ...interface{}) () {
  ...
  case 0:
    ...
    // invoke: bool isValid()
    var ret = C.C_ZNK17QAccessibleObject7isValidEv(this.qclsinst)
    if false {reflect.TypeOf(ret)}
  default:
...
func (this *QAccessibleObject) childAt(args ...interface{}) () {
  ...
  case 0:
    ...
    var ret = C.C_ZNK17QAccessibleObject7childAtEii(this.qclsinst, arg0, arg1)
    if false {reflect.TypeOf(ret)}
  default:
...
func (this *QAccessibleObject) rect(args ...interface{}) () {
  ...
  case 0:
    ...
    // invoke: QRect rect()
    var ret = C.C_ZNK17QAccessibleObject4rectEv(this.qclsinst)
    if false {reflect.TypeOf(ret)}
  default:
