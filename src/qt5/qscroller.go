...
extern void _ZN9QScroller8scrollerEP7QObject(void* arg0); // 4
  // proto: static const QScroller * QScroller::scroller(const QObject * target);
extern void _ZN9QScroller8scrollerEPK7QObject(void* arg0); // 4
  // proto:  void QScroller::scrollTo(const QPointF & pos, int scrollTime);
extern void _ZN9QScroller8scrollToERK7QPointFi(void* qthis, void* arg0, int32_t arg1); // 4
  // proto:  void QScroller::scrollTo(const QPointF & pos);
extern void _ZN9QScroller8scrollToERK7QPointF(void* qthis, void* arg0); // 4
  // proto: static QList<QScroller *> QScroller::activeScrollers();
extern void _ZN9QScroller15activeScrollersEv(); // 4
  // proto: static bool QScroller::hasScroller(QObject * target);
extern void _ZN9QScroller11hasScrollerEP7QObject(void* arg0); // 4
  // proto:  void QScroller::setSnapPositionsY(qreal first, qreal interval);
extern void _ZN9QScroller17setSnapPositionsYEdd(void* qthis, double arg0, double arg1); // 4
  // proto:  void QScroller::setSnapPositionsX(qreal first, qreal interval);
extern void _ZN9QScroller17setSnapPositionsXEdd(void* qthis, double arg0, double arg1); // 4
  // proto: static void QScroller::ungrabGesture(QObject * target);
extern void _ZN9QScroller13ungrabGestureEP7QObject(void* arg0); // 4
  // proto:  QScroller::State QScroller::state();
extern void _ZNK9QScroller5stateEv(void* qthis); // 4
  // proto:  void QScroller::resendPrepareEvent();
extern void _ZN9QScroller18resendPrepareEventEv(void* qthis); // 4
  // proto:  void QScroller::stop();
extern void _ZN9QScroller4stopEv(void* qthis); // 4
  // proto:  QScrollerProperties QScroller::scrollerProperties();
extern void _ZNK9QScroller18scrollerPropertiesEv(void* qthis); // 4
  // proto:  QPointF QScroller::finalPosition();
extern void _ZNK9QScroller13finalPositionEv(void* qthis); // 4
  // proto:  void QScroller::ensureVisible(const QRectF & rect, qreal xmargin, qreal ymargin, int scrollTime);
extern void _ZN9QScroller13ensureVisibleERK6QRectFddi(void* qthis, void* arg0, double arg1, double arg2, int32_t arg3); // 4
  // proto:  void QScroller::ensureVisible(const QRectF & rect, qreal xmargin, qreal ymargin);
extern void _ZN9QScroller13ensureVisibleERK6QRectFdd(void* qthis, void* arg0, double arg1, double arg2); // 4
  // proto:  QPointF QScroller::pixelPerMeter();
extern void _ZNK9QScroller13pixelPerMeterEv(void* qthis); // 4
  // proto:  const QMetaObject * QScroller::metaObject();
extern void _ZNK9QScroller10metaObjectEv(void* qthis); // 4
  // proto:  QObject * QScroller::target();
extern void _ZNK9QScroller6targetEv(void* qthis); // 4
  // proto: static Qt::GestureType QScroller::grabbedGesture(QObject * target);
extern void _ZN9QScroller14grabbedGestureEP7QObject(void* arg0); // 4
  // proto:  void QScroller::setScrollerProperties(const QScrollerProperties & prop);
extern void _ZN9QScroller21setScrollerPropertiesERK19QScrollerProperties(void* qthis, void* arg0); // 4
  // proto:  QPointF QScroller::velocity();
extern void _ZNK9QScroller8velocityEv(void* qthis); // 4
*/
import "C"
// } // <= ext block end
...
func (this *QScroller) activeScrollers_s(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZN9QScroller15activeScrollersEv()
  default:
...
func (this *QScroller) hasScroller_s(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = args[0].(QObject).qclsinst
    if false {fmt.Println(arg0)}
    C._ZN9QScroller11hasScrollerEP7QObject(arg0)
  default:
...
func (this *QScroller) ungrabGesture_s(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = args[0].(QObject).qclsinst
    if false {fmt.Println(arg0)}
    C._ZN9QScroller13ungrabGestureEP7QObject(arg0)
  default:
...
func (this *QScroller) state(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK9QScroller5stateEv(this.qclsinst)
  default:
...
func (this *QScroller) grabbedGesture_s(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = args[0].(QObject).qclsinst
    if false {fmt.Println(arg0)}
    C._ZN9QScroller14grabbedGestureEP7QObject(arg0)
  default:
