...
extern void _ZNK12QEasingCurve9overshootEv(void* qthis); // 4
  // proto:  qreal QEasingCurve::period();
extern void _ZNK12QEasingCurve6periodEv(void* qthis); // 4
  // proto:  qreal QEasingCurve::valueForProgress(qreal progress);
extern void _ZNK12QEasingCurve16valueForProgressEd(void* qthis, double arg0); // 4
  // proto:  QVector<QPointF> QEasingCurve::toCubicSpline();
extern void _ZNK12QEasingCurve13toCubicSplineEv(void* qthis); // 4
  // proto:  void QEasingCurve::addCubicBezierSegment(const QPointF & c1, const QPointF & c2, const QPointF & endPoint);
extern void _ZN12QEasingCurve21addCubicBezierSegmentERK7QPointFS2_S2_(void* qthis, void* arg0, void* arg1, void* arg2); // 4
  // proto:  void QEasingCurve::QEasingCurve(const QEasingCurve & other);
extern void _ZN12QEasingCurveC2ERKS_(void* qthis, void* arg0); // 3
  // proto:  QEasingCurve::Type QEasingCurve::type();
extern void _ZNK12QEasingCurve4typeEv(void* qthis); // 4
  // proto:  void QEasingCurve::swap(QEasingCurve & other);
extern void _ZN12QEasingCurve4swapERS_(void* qthis, void* arg0); // 2
  // proto:  void QEasingCurve::addTCBSegment(const QPointF & nextPoint, qreal t, qreal c, qreal b);
extern void _ZN12QEasingCurve13addTCBSegmentERK7QPointFddd(void* qthis, void* arg0, double arg1, double arg2, double arg3); // 4
  // proto:  void QEasingCurve::setAmplitude(qreal amplitude);
extern void _ZN12QEasingCurve12setAmplitudeEd(void* qthis, double arg0); // 4
  // proto:  void QEasingCurve::~QEasingCurve();
extern void _ZN12QEasingCurveD2Ev(void* qthis); // 4
  // proto:  void QEasingCurve::setPeriod(qreal period);
extern void _ZN12QEasingCurve9setPeriodEd(void* qthis, double arg0); // 4
  // proto:  EasingFunction QEasingCurve::customType();
extern void _ZNK12QEasingCurve10customTypeEv(void* qthis); // 4
  // proto:  void QEasingCurve::setOvershoot(qreal overshoot);
extern void _ZN12QEasingCurve12setOvershootEd(void* qthis, double arg0); // 4
  // proto:  qreal QEasingCurve::amplitude();
extern void _ZNK12QEasingCurve9amplitudeEv(void* qthis); // 4
*/
import "C"
// } // <= ext block end
...
func (this *QEasingCurve) overshoot(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK12QEasingCurve9overshootEv(this.qclsinst)
  default:
...
func (this *QEasingCurve) period(args ...interface{}) () {
  ...
  case 0:
    ...
    // invoke: qreal period()
    C._ZNK12QEasingCurve6periodEv(this.qclsinst)
  default:
...
func (this *QEasingCurve) valueForProgress(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK12QEasingCurve16valueForProgressEd(this.qclsinst, arg0)
  default:
...
func (this *QEasingCurve) toCubicSpline(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK12QEasingCurve13toCubicSplineEv(this.qclsinst)
  default:
...
func (this *QEasingCurve) addCubicBezierSegment(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZN12QEasingCurve21addCubicBezierSegmentERK7QPointFS2_S2_(this.qclsinst, arg0, arg1, arg2)
  default:
...
func NewQEasingCurve(args ...interface{}) QEasingCurve {
  ...
  case 0:
    ...
    C._ZN12QEasingCurveC2ERKS_(qthis, arg0)
  default:
...
func (this *QEasingCurve) type_(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK12QEasingCurve4typeEv(this.qclsinst)
  default:
...
func (this *QEasingCurve) swap(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = args[0].(QEasingCurve).qclsinst
    if false {fmt.Println(arg0)}
    C._ZN12QEasingCurve4swapERS_(this.qclsinst, arg0)
  default:
...
func (this *QEasingCurve) addTCBSegment(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZN12QEasingCurve13addTCBSegmentERK7QPointFddd(this.qclsinst, arg0, arg1, arg2, arg3)
  default:
...
func (this *QEasingCurve) setAmplitude(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = C.double(args[0].(float64))
    if false {fmt.Println(arg0)}
    C._ZN12QEasingCurve12setAmplitudeEd(this.qclsinst, arg0)
  default:
...
func (this *QEasingCurve) FreeQEasingCurve(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZN12QEasingCurveD2Ev(this.qclsinst)
  default:
    qtrt.ErrorResolve("QEasingCurve", "~QEasingCurve", args)
  }
...
func (this *QEasingCurve) setPeriod(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = C.double(args[0].(float64))
    if false {fmt.Println(arg0)}
    C._ZN12QEasingCurve9setPeriodEd(this.qclsinst, arg0)
  default:
...
func (this *QEasingCurve) customType(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK12QEasingCurve10customTypeEv(this.qclsinst)
  default:
...
func (this *QEasingCurve) setOvershoot(args ...interface{}) () {
  ...
  case 0:
    ...
    var arg0 = C.double(args[0].(float64))
    if false {fmt.Println(arg0)}
    C._ZN12QEasingCurve12setOvershootEd(this.qclsinst, arg0)
  default:
...
func (this *QEasingCurve) amplitude(args ...interface{}) () {
  ...
  case 0:
    ...
    C._ZNK12QEasingCurve9amplitudeEv(this.qclsinst)
  default:
