...
func NewQWinJumpListCategory(title *qtcore.QString) *QWinJumpListCategory {
...
// Public Visibility=Default Availability=Available
// [8] QString title()
func (this *QWinJumpListCategory) Title() *qtcore.QString /*123*/ {
...
func (this *QWinJumpListCategory) SetTitle(title *qtcore.QString) {
	var convArg0 = title.GetCthis()
...
func (this *QWinJumpListCategory) AddDestination(filePath *qtcore.QString) *QWinJumpListItem /*777 QWinJumpListItem **/ {
	...
	gopp.ErrPrint(err, rv)
	//  return rv
	rv2 := /*==*/ NewQWinJumpListItemFromPointer(unsafe.Pointer(uintptr(rv))) // 444
	return rv2
}
...
func (this *QWinJumpListCategory) AddLink(title *qtcore.QString, executablePath *qtcore.QString, arguments *qtcore.QStringList) *QWinJumpListItem /*777 QWinJumpListItem **/ {
	var convArg0 = title.GetCthis()
	var convArg1 = executablePath.GetCthis()
...
func (this *QWinJumpListCategory) AddLink_1(icon *qtgui.QIcon, title *qtcore.QString, executablePath *qtcore.QString, arguments *qtcore.QStringList) *QWinJumpListItem /*777 QWinJumpListItem **/ {
	var convArg0 = icon.GetCthis()
	var convArg1 = title.GetCthis()
	var convArg2 = executablePath.GetCthis()
