...
func NewQNetworkProxyQuery() *QNetworkProxyQuery {
	rv, err := ffiqt.InvokeQtFunc6("_ZN18QNetworkProxyQueryC2Ev", ffiqt.FFI_TYPE_POINTER)
...
func NewQNetworkProxyQuery_1(requestUrl *qtcore.QUrl, queryType int) *QNetworkProxyQuery {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN18QNetworkProxyQueryC2ERK4QUrlNS_9QueryTypeE", ffiqt.FFI_TYPE_POINTER, convArg0, queryType)
	gopp.ErrPrint(err, rv)
	gothis := NewQNetworkProxyQueryFromPointer(unsafe.Pointer(uintptr(rv)))
	return gothis
}
...
func NewQNetworkProxyQuery_2(hostname *qtcore.QString, port int, protocolTag *qtcore.QString, queryType int) *QNetworkProxyQuery {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN18QNetworkProxyQueryC2ERK7QStringiS2_NS_9QueryTypeE", ffiqt.FFI_TYPE_POINTER, convArg0, port, convArg2, queryType)
	gopp.ErrPrint(err, rv)
	gothis := NewQNetworkProxyQueryFromPointer(unsafe.Pointer(uintptr(rv)))
	return gothis
}
...
func NewQNetworkProxyQuery_3(bindPort uint16, protocolTag *qtcore.QString, queryType int) *QNetworkProxyQuery {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN18QNetworkProxyQueryC2EtRK7QStringNS_9QueryTypeE", ffiqt.FFI_TYPE_POINTER, bindPort, convArg1, queryType)
	gopp.ErrPrint(err, rv)
	gothis := NewQNetworkProxyQueryFromPointer(unsafe.Pointer(uintptr(rv)))
	return gothis
}
...
func NewQNetworkProxyQuery_4(networkConfiguration *QNetworkConfiguration, requestUrl *qtcore.QUrl, queryType int) *QNetworkProxyQuery {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN18QNetworkProxyQueryC2ERK21QNetworkConfigurationRK4QUrlNS_9QueryTypeE", ffiqt.FFI_TYPE_POINTER, convArg0, convArg1, queryType)
	gopp.ErrPrint(err, rv)
	gothis := NewQNetworkProxyQueryFromPointer(unsafe.Pointer(uintptr(rv)))
	return gothis
}
...
func NewQNetworkProxyQuery_5(networkConfiguration *QNetworkConfiguration, hostname *qtcore.QString, port int, protocolTag *qtcore.QString, queryType int) *QNetworkProxyQuery {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN18QNetworkProxyQueryC2ERK21QNetworkConfigurationRK7QStringiS5_NS_9QueryTypeE", ffiqt.FFI_TYPE_POINTER, convArg0, convArg1, port, convArg3, queryType)
	gopp.ErrPrint(err, rv)
	gothis := NewQNetworkProxyQueryFromPointer(unsafe.Pointer(uintptr(rv)))
	return gothis
}
...
func NewQNetworkProxyQuery_6(networkConfiguration *QNetworkConfiguration, bindPort uint16, protocolTag *qtcore.QString, queryType int) *QNetworkProxyQuery {
	var convArg0 = networkConfiguration.GetCthis()
	var convArg2 = protocolTag.GetCthis()
	rv, err := ffiqt.InvokeQtFunc6("_ZN18QNetworkProxyQueryC2ERK21QNetworkConfigurationtRK7QStringNS_9QueryTypeE", ffiqt.FFI_TYPE_POINTER, convArg0, bindPort, convArg2, queryType)
	gopp.ErrPrint(err, rv)
	gothis := NewQNetworkProxyQueryFromPointer(unsafe.Pointer(uintptr(rv)))
	return gothis
}
...
func (this *QNetworkProxyQuery) PeerHostName() *qtcore.QString /*123*/ {
	rv, err := ffiqt.InvokeQtFunc6("_ZNK18QNetworkProxyQuery12peerHostNameEv", ffiqt.FFI_TYPE_POINTER, this.GetCthis())
	gopp.ErrPrint(err, rv)
	//  return rv
...
func (this *QNetworkProxyQuery) ProtocolTag() *qtcore.QString /*123*/ {
	rv, err := ffiqt.InvokeQtFunc6("_ZNK18QNetworkProxyQuery11protocolTagEv", ffiqt.FFI_TYPE_POINTER, this.GetCthis())
	gopp.ErrPrint(err, rv)
	//  return rv
	rv2 := qtcore.NewQStringFromPointer(unsafe.Pointer(uintptr(rv))) // 333
	return rv2
...
func (this *QNetworkProxyQuery) Url() *qtcore.QUrl /*123*/ {
	rv, err := ffiqt.InvokeQtFunc6("_ZNK18QNetworkProxyQuery3urlEv", ffiqt.FFI_TYPE_POINTER, this.GetCthis())
	gopp.ErrPrint(err, rv)
	//  return rv
...
func (this *QNetworkProxyQuery) NetworkConfiguration() *QNetworkConfiguration /*123*/ {
	rv, err := ffiqt.InvokeQtFunc6("_ZNK18QNetworkProxyQuery20networkConfigurationEv", ffiqt.FFI_TYPE_POINTER, this.GetCthis())
	gopp.ErrPrint(err, rv)
	//  return rv
