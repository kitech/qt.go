...
func NewQUdpSocket(parent *qtcore.QObject /*777 QObject **/) *QUdpSocket {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN10QUdpSocketC2EP7QObject", ffiqt.FFI_TYPE_VOID, cthis, convArg0)
	gopp.ErrPrint(err, rv)
	gothis := NewQUdpSocketFromPointer(cthis)
	return gothis
}
...
// index:0
// Public
// bool joinMulticastGroup(const class QHostAddress &)
...
// index:1
// Public
// bool joinMulticastGroup(const class QHostAddress &, const class QNetworkInterface &)
...
// index:0
// Public
// bool leaveMulticastGroup(const class QHostAddress &)
...
// index:1
// Public
// bool leaveMulticastGroup(const class QHostAddress &, const class QNetworkInterface &)
...
func (this *QUdpSocket) MulticastInterface() *QNetworkInterface /*123*/ {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZNK10QUdpSocket18multicastInterfaceEv", ffiqt.FFI_TYPE_POINTER, mv, this.GetCthis())
	gopp.ErrPrint(err, rv)
	//  return rv
...
// index:0
// Public
// void setMulticastInterface(const class QNetworkInterface &)
...
func (this *QUdpSocket) ReceiveDatagram(maxSize int64) *QNetworkDatagram /*123*/ {
	mv := qtrt.Calloc(1, 256)
	rv, err := ffiqt.InvokeQtFunc6("_ZN10QUdpSocket15receiveDatagramEx", ffiqt.FFI_TYPE_POINTER, mv, this.GetCthis(), maxSize)
	gopp.ErrPrint(err, rv)
	//  return rv
	rv = uint64(uintptr(mv))
...
// index:0
// Public
// qint64 readDatagram(char *, qint64, class QHostAddress *, quint16 *)
...
// index:0
// Public
// qint64 writeDatagram(const class QNetworkDatagram &)
...
// index:1
// Public
// qint64 writeDatagram(const char *, qint64, const class QHostAddress &, quint16)
...
// index:2
// Public inline
// qint64 writeDatagram(const class QByteArray &, const class QHostAddress &, quint16)
