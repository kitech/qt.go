...
func NewQHostAddress() *QHostAddress {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN12QHostAddressC2Ev", ffiqt.FFI_TYPE_VOID, cthis)
	gopp.ErrPrint(err, rv)
	gothis := NewQHostAddressFromPointer(cthis)
	return gothis
}
...
func NewQHostAddress_1(ip4Addr uint) *QHostAddress {
	cthis := qtrt.Calloc(1, 256) // 8
	rv, err := ffiqt.InvokeQtFunc6("_ZN12QHostAddressC2Ej", ffiqt.FFI_TYPE_VOID, cthis, ip4Addr)
	gopp.ErrPrint(err, rv)
	gothis := NewQHostAddressFromPointer(cthis)
	return gothis
}
...
func NewQHostAddress_2(ip6Addr unsafe.Pointer /*666*/) *QHostAddress {
	cthis := qtrt.Calloc(1, 256) // 8
	rv, err := ffiqt.InvokeQtFunc6("_ZN12QHostAddressC2EPh", ffiqt.FFI_TYPE_VOID, cthis, &ip6Addr)
	gopp.ErrPrint(err, rv)
	gothis := NewQHostAddressFromPointer(cthis)
	return gothis
}
...
func NewQHostAddress_3(ip6Addr unsafe.Pointer /*666*/) *QHostAddress {
	cthis := qtrt.Calloc(1, 256) // 8
	rv, err := ffiqt.InvokeQtFunc6("_ZN12QHostAddressC2EPKh", ffiqt.FFI_TYPE_VOID, cthis, &ip6Addr)
	gopp.ErrPrint(err, rv)
	gothis := NewQHostAddressFromPointer(cthis)
	return gothis
}
...
func NewQHostAddress_4(address *qtcore.QString) *QHostAddress {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN12QHostAddressC2ERK7QString", ffiqt.FFI_TYPE_VOID, cthis, convArg0)
	gopp.ErrPrint(err, rv)
	gothis := NewQHostAddressFromPointer(cthis)
	return gothis
}
...
// index:3
// Public
// bool setAddress(const class QString &)
...
func (this *QHostAddress) ToString() *qtcore.QString /*123*/ {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZNK12QHostAddress8toStringEv", ffiqt.FFI_TYPE_POINTER, mv, this.GetCthis())
	gopp.ErrPrint(err, rv)
	//  return rv
...
func (this *QHostAddress) ScopeId() *qtcore.QString /*123*/ {
	mv := qtrt.Calloc(1, 256)
	rv, err := ffiqt.InvokeQtFunc6("_ZNK12QHostAddress7scopeIdEv", ffiqt.FFI_TYPE_POINTER, mv, this.GetCthis())
	gopp.ErrPrint(err, rv)
	//  return rv
	rv = uint64(uintptr(mv))
	rv2 := qtcore.NewQStringFromPointer(unsafe.Pointer(uintptr(rv))) // 333
...
// index:0
// Public
// void setScopeId(const class QString &)
...
// index:0
// Public
// bool isInSubnet(const class QHostAddress &, int)
