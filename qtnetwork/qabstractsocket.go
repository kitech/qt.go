...
func NewQAbstractSocket(socketType int, parent *qtcore.QObject /*777 QObject **/) *QAbstractSocket {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QAbstractSocketC2ENS_10SocketTypeEP7QObject", ffiqt.FFI_TYPE_POINTER, socketType, convArg1)
	gopp.ErrPrint(err, rv)
...
func (this *QAbstractSocket) LocalAddress() *QHostAddress /*123*/ {
	rv, err := ffiqt.InvokeQtFunc6("_ZNK15QAbstractSocket12localAddressEv", ffiqt.FFI_TYPE_POINTER, this.GetCthis())
	gopp.ErrPrint(err, rv)
	//  return rv
...
func (this *QAbstractSocket) PeerAddress() *QHostAddress /*123*/ {
	rv, err := ffiqt.InvokeQtFunc6("_ZNK15QAbstractSocket11peerAddressEv", ffiqt.FFI_TYPE_POINTER, this.GetCthis())
	gopp.ErrPrint(err, rv)
	//  return rv
	rv2 := /*==*/ NewQHostAddressFromPointer(unsafe.Pointer(uintptr(rv))) // 333
	return rv2
...
func (this *QAbstractSocket) PeerName() *qtcore.QString /*123*/ {
	rv, err := ffiqt.InvokeQtFunc6("_ZNK15QAbstractSocket8peerNameEv", ffiqt.FFI_TYPE_POINTER, this.GetCthis())
	gopp.ErrPrint(err, rv)
	//  return rv
...
func (this *QAbstractSocket) SocketOption(option int) *qtcore.QVariant /*123*/ {
	rv, err := ffiqt.InvokeQtFunc6("_ZN15QAbstractSocket12socketOptionENS_12SocketOptionE", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), option)
	gopp.ErrPrint(err, rv)
	//  return rv
...
func (this *QAbstractSocket) Proxy() *QNetworkProxy /*123*/ {
	rv, err := ffiqt.InvokeQtFunc6("_ZNK15QAbstractSocket5proxyEv", ffiqt.FFI_TYPE_POINTER, this.GetCthis())
	gopp.ErrPrint(err, rv)
	//  return rv
