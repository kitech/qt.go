...
func (this *QAbstractSocket) InheritSetPeerName(f func(name *qtcore.QString) /*void*/) {
...
func (this *QAbstractSocket) ConnectToHost(hostName *qtcore.QString, port uint16, mode int, protocol int) {
