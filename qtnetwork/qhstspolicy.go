...
func NewQHstsPolicy() *QHstsPolicy {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN11QHstsPolicyC2Ev", ffiqt.FFI_TYPE_VOID, cthis)
	gopp.ErrPrint(err, rv)
	gothis := NewQHstsPolicyFromPointer(cthis)
	return gothis
}
...
func NewQHstsPolicy_1(expiry *qtcore.QDateTime, flags int, host *qtcore.QString, mode int) *QHstsPolicy {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN11QHstsPolicyC2ERK9QDateTime6QFlagsINS_10PolicyFlagEERK7QStringN4QUrl11ParsingModeE", ffiqt.FFI_TYPE_VOID, cthis, convArg0, flags, convArg2, mode)
	gopp.ErrPrint(err, rv)
	gothis := NewQHstsPolicyFromPointer(cthis)
	return gothis
}
...
func (this *QHstsPolicy) Expiry() *qtcore.QDateTime /*123*/ {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZNK11QHstsPolicy6expiryEv", ffiqt.FFI_TYPE_POINTER, mv, this.GetCthis())
	gopp.ErrPrint(err, rv)
	//  return rv
