...
func (this *QDateTimeEdit) InheritDateTimeFromText(f func(text *qtcore.QString) unsafe.Pointer) {
	ffiqt.SetAllInheritCallback(this, "dateTimeFromText", f)
}
...
func (this *QDateTimeEdit) InheritTextFromDateTime(f func(dt *qtcore.QDateTime) unsafe.Pointer) {
	ffiqt.SetAllInheritCallback(this, "textFromDateTime", f)
}
...
func NewQDateTimeEdit(parent *QWidget /*777 QWidget **/) *QDateTimeEdit {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN13QDateTimeEditC2EP7QWidget", ffiqt.FFI_TYPE_POINTER, convArg0)
	gopp.ErrPrint(err, rv)
...
func NewQDateTimeEdit_1(dt *qtcore.QDateTime, parent *QWidget /*777 QWidget **/) *QDateTimeEdit {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN13QDateTimeEditC2ERK9QDateTimeP7QWidget", ffiqt.FFI_TYPE_POINTER, convArg0, convArg1)
	gopp.ErrPrint(err, rv)
	gothis := NewQDateTimeEditFromPointer(unsafe.Pointer(uintptr(rv)))
	return gothis
}
...
func NewQDateTimeEdit_2(d *qtcore.QDate, parent *QWidget /*777 QWidget **/) *QDateTimeEdit {
	...
	var convArg1 = parent.GetCthis()
	rv, err := ffiqt.InvokeQtFunc6("_ZN13QDateTimeEditC2ERK5QDateP7QWidget", ffiqt.FFI_TYPE_POINTER, convArg0, convArg1)
	gopp.ErrPrint(err, rv)
	gothis := NewQDateTimeEditFromPointer(unsafe.Pointer(uintptr(rv)))
	return gothis
}
...
func NewQDateTimeEdit_3(t *qtcore.QTime, parent *QWidget /*777 QWidget **/) *QDateTimeEdit {
	...
	var convArg1 = parent.GetCthis()
	rv, err := ffiqt.InvokeQtFunc6("_ZN13QDateTimeEditC2ERK5QTimeP7QWidget", ffiqt.FFI_TYPE_POINTER, convArg0, convArg1)
	gopp.ErrPrint(err, rv)
	gothis := NewQDateTimeEditFromPointer(unsafe.Pointer(uintptr(rv)))
	return gothis
}
...
func NewQDateTimeEdit_4(val *qtcore.QVariant, parserType int, parent *QWidget /*777 QWidget **/) *QDateTimeEdit {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN13QDateTimeEditC2ERK8QVariantNS0_4TypeEP7QWidget", ffiqt.FFI_TYPE_POINTER, convArg0, parserType, convArg2)
	gopp.ErrPrint(err, rv)
	gothis := NewQDateTimeEditFromPointer(unsafe.Pointer(uintptr(rv)))
	return gothis
}
