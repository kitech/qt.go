...
// index:0
// Public Visibility=Default Availability=Available
// [1] bool focusOnTouch() const

/*

 */
func (this *QGraphicsScene) FocusOnTouch() bool {
	rv, err := qtrt.InvokeQtFunc6("_ZNK14QGraphicsScene12focusOnTouchEv", qtrt.FFI_TYPE_POINTER, this.GetCthis())
	qtrt.ErrPrint(err, rv)
	return rv != 0
}
...
func (this *QGraphicsScene) SetFocusOnTouch(enabled bool) {
	rv, err := qtrt.InvokeQtFunc6("_ZN14QGraphicsScene15setFocusOnTouchEb", qtrt.FFI_TYPE_POINTER, this.GetCthis(), enabled)
	qtrt.ErrPrint(err, rv)
}
