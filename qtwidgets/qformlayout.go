...
func (this *QFormLayout) TakeRow(row int) unsafe.Pointer /*444*/ {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN11QFormLayout7takeRowEi", ffiqt.FFI_TYPE_POINTER, mv, this.GetCthis(), row)
	gopp.ErrPrint(err, rv)
	//  return rv
