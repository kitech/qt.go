 ...
 */
func (*QAccessibleTextCursorEvent) NewForInherit(obj qtcore.QObject_ITF /*777 QObject **/, cursorPos int) *QAccessibleTextCursorEvent {
	return NewQAccessibleTextCursorEvent(obj, cursorPos)
}
