...
See also save().
*/
func (this *QPicture) Loadp(dev qtcore.QIODevice_ITF /*777 QIODevice **/) bool {
	var convArg0 unsafe.Pointer
	if dev != nil && dev.QIODevice_PTR() != nil {
		convArg0 = dev.QIODevice_PTR().GetCthis()
	}
...
See also load().
*/
func (this *QPicture) Savep(dev qtcore.QIODevice_ITF /*777 QIODevice **/) bool {
	var convArg0 unsafe.Pointer
	if dev != nil && dev.QIODevice_PTR() != nil {
		convArg0 = dev.QIODevice_PTR().GetCthis()
	}
 ...
 */
func (this *QPicture) Operator_equal1(other unsafe.Pointer /*333*/) *QPicture {
