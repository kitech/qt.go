...
func (this *QStyleHints) SetMouseQuickSelectionThreshold(threshold int) {
	rv, err := qtrt.InvokeQtFunc6("_ZN11QStyleHints31setMouseQuickSelectionThresholdEi", qtrt.FFI_TYPE_POINTER, this.GetCthis(), threshold)
	qtrt.ErrPrint(err, rv)
}
...
// index:0
// Public Visibility=Default Availability=Available
// [4] int mouseQuickSelectionThreshold() const

/*

 */
func (this *QStyleHints) MouseQuickSelectionThreshold() int {
	rv, err := qtrt.InvokeQtFunc6("_ZNK11QStyleHints28mouseQuickSelectionThresholdEv", qtrt.FFI_TYPE_POINTER, this.GetCthis())
	qtrt.ErrPrint(err, rv)
	return qtrt.Cretval2go("int", rv).(int) // 1111
}
...
func (this *QStyleHints) MouseQuickSelectionThresholdChanged(threshold int) {
	rv, err := qtrt.InvokeQtFunc6("_ZN11QStyleHints35mouseQuickSelectionThresholdChangedEi", qtrt.FFI_TYPE_POINTER, this.GetCthis(), threshold)
	qtrt.ErrPrint(err, rv)
}
