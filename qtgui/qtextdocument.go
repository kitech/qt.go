...
func NewQTextDocument(parent *qtcore.QObject /*777 QObject **/) *QTextDocument {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN13QTextDocumentC2EP7QObject", ffiqt.FFI_TYPE_POINTER, convArg0)
	gopp.ErrPrint(err, rv)
...
func NewQTextDocument_1(text *qtcore.QString, parent *qtcore.QObject /*777 QObject **/) *QTextDocument {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZN13QTextDocumentC2ERK7QStringP7QObject", ffiqt.FFI_TYPE_POINTER, convArg0, convArg1)
	gopp.ErrPrint(err, rv)
	gothis := NewQTextDocumentFromPointer(unsafe.Pointer(uintptr(rv)))
	return gothis
}
...
func (this *QTextDocument) Find(subString *qtcore.QString, from int, options int) *QTextCursor /*123*/ {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZNK13QTextDocument4findERK7QStringi6QFlagsINS_8FindFlagEE", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), convArg0, from, options)
	gopp.ErrPrint(err, rv)
	//  return rv
...
func (this *QTextDocument) Find_1(subString *qtcore.QString, cursor *QTextCursor, options int) *QTextCursor /*123*/ {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZNK13QTextDocument4findERK7QStringRK11QTextCursor6QFlagsINS_8FindFlagEE", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), convArg0, convArg1, options)
	gopp.ErrPrint(err, rv)
	//  return rv
	rv2 := /*==*/ NewQTextCursorFromPointer(unsafe.Pointer(uintptr(rv))) // 333
	qtrt.SetFinalizer(rv2 /*==*/, DeleteQTextCursor)
...
func (this *QTextDocument) Find_2(expr *qtcore.QRegExp, from int, options int) *QTextCursor /*123*/ {
	...
	rv, err := ffiqt.InvokeQtFunc6("_ZNK13QTextDocument4findERK7QRegExpi6QFlagsINS_8FindFlagEE", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), convArg0, from, options)
	gopp.ErrPrint(err, rv)
	//  return rv
	rv2 := /*==*/ NewQTextCursorFromPointer(unsafe.Pointer(uintptr(rv))) // 333
	qtrt.SetFinalizer(rv2 /*==*/, DeleteQTextCursor)
...
func (this *QTextDocument) Find_3(expr *qtcore.QRegExp, cursor *QTextCursor, options int) *QTextCursor /*123*/ {
	var convArg0 = expr.GetCthis()
	var convArg1 = cursor.GetCthis()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK13QTextDocument4findERK7QRegExpRK11QTextCursor6QFlagsINS_8FindFlagEE", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), convArg0, convArg1, options)
	gopp.ErrPrint(err, rv)
	//  return rv
	rv2 := /*==*/ NewQTextCursorFromPointer(unsafe.Pointer(uintptr(rv))) // 333
	qtrt.SetFinalizer(rv2 /*==*/, DeleteQTextCursor)
...
func (this *QTextDocument) Find_4(expr *qtcore.QRegularExpression, from int, options int) *QTextCursor /*123*/ {
	var convArg0 = expr.GetCthis()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK13QTextDocument4findERK18QRegularExpressioni6QFlagsINS_8FindFlagEE", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), convArg0, from, options)
	gopp.ErrPrint(err, rv)
	//  return rv
	rv2 := /*==*/ NewQTextCursorFromPointer(unsafe.Pointer(uintptr(rv))) // 333
	qtrt.SetFinalizer(rv2 /*==*/, DeleteQTextCursor)
...
func (this *QTextDocument) Find_5(expr *qtcore.QRegularExpression, cursor *QTextCursor, options int) *QTextCursor /*123*/ {
	var convArg0 = expr.GetCthis()
	var convArg1 = cursor.GetCthis()
	rv, err := ffiqt.InvokeQtFunc6("_ZNK13QTextDocument4findERK18QRegularExpressionRK11QTextCursor6QFlagsINS_8FindFlagEE", ffiqt.FFI_TYPE_POINTER, this.GetCthis(), convArg0, convArg1, options)
	gopp.ErrPrint(err, rv)
	//  return rv
	rv2 := /*==*/ NewQTextCursorFromPointer(unsafe.Pointer(uintptr(rv))) // 333
	qtrt.SetFinalizer(rv2 /*==*/, DeleteQTextCursor)
...
func (this *QTextDocument) TextWidth() float64 {
	rv, err := ffiqt.InvokeQtFunc6("_ZNK13QTextDocument9textWidthEv", ffiqt.FFI_TYPE_DOUBLE, this.GetCthis())
	gopp.ErrPrint(err, rv)
	//  return rv
...
func (this *QTextDocument) IdealWidth() float64 {
	rv, err := ffiqt.InvokeQtFunc6("_ZNK13QTextDocument10idealWidthEv", ffiqt.FFI_TYPE_DOUBLE, this.GetCthis())
	gopp.ErrPrint(err, rv)
	//  return rv
	return qtrt.Cretval2go("float64", rv).(float64) // 1111
}
...
func (this *QTextDocument) IndentWidth() float64 {
	rv, err := ffiqt.InvokeQtFunc6("_ZNK13QTextDocument11indentWidthEv", ffiqt.FFI_TYPE_DOUBLE, this.GetCthis())
	gopp.ErrPrint(err, rv)
	//  return rv
	return qtrt.Cretval2go("float64", rv).(float64) // 1111
}
...
func (this *QTextDocument) DocumentMargin() float64 {
	rv, err := ffiqt.InvokeQtFunc6("_ZNK13QTextDocument14documentMarginEv", ffiqt.FFI_TYPE_DOUBLE, this.GetCthis())
	gopp.ErrPrint(err, rv)
	//  return rv
	return qtrt.Cretval2go("float64", rv).(float64) // 1111
}
