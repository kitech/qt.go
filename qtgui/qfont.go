...
func NewQFont(family string, pointSize int, weight int, italic bool) *QFont {
	...
	rv, err := qtrt.Qtcc1(1453900756, "_ZN5QFontC2ERK7QStringiib", qtrt.FFITY_POINTER, cthis, convArg0, pointSize, weight, italic)
...
func (this *QFont) SetFamily(arg0 string) {
	...
	var convArg0 = tmpArg0.GetCthis()
	rv, err := qtrt.Qtcc1(3823958997, "_ZN5QFont9setFamilyERK7QString", qtrt.FFITY_POINTER, this.GetCthis(), convArg0)
	qtrt.ErrPrint(err, rv)
}
...
func (this *QFont) SetStyleName(arg0 string) {
	var tmpArg0 = qtcore.NewQString5(arg0)
	var convArg0 = tmpArg0.GetCthis()
	rv, err := qtrt.Qtcc1(814338029, "_ZN5QFont12setStyleNameERK7QString", qtrt.FFITY_POINTER, this.GetCthis(), convArg0)
	qtrt.ErrPrint(err, rv)
}
...
func (this *QFont) PointSize() int {
	rv, err := qtrt.Qtcc1(3023852881, "_ZNK5QFont9pointSizeEv", qtrt.FFITY_POINTER, this.GetCthis())
	qtrt.ErrPrint(err, rv)
...
func (this *QFont) SetPointSize(arg0 int) {
	rv, err := qtrt.Qtcc1(1776764880, "_ZN5QFont12setPointSizeEi", qtrt.FFITY_POINTER, this.GetCthis(), arg0)
	qtrt.ErrPrint(err, rv)
}
...
func (this *QFont) PointSizeF() float64 {
	rv, err := qtrt.Qtcc1(314855354, "_ZNK5QFont10pointSizeFEv", qtrt.FFI_TYPE_DOUBLE, this.GetCthis())
	qtrt.ErrPrint(err, rv)
...
func (this *QFont) SetPointSizeF(arg0 float64) {
	rv, err := qtrt.Qtcc1(2339912505, "_ZN5QFont13setPointSizeFEd", qtrt.FFITY_POINTER, this.GetCthis(), arg0)
	qtrt.ErrPrint(err, rv)
}
...
func (this *QFont) PixelSize() int {
	rv, err := qtrt.Qtcc1(197311963, "_ZNK5QFont9pixelSizeEv", qtrt.FFITY_POINTER, this.GetCthis())
	qtrt.ErrPrint(err, rv)
	return qtrt.Cretval2go("int", rv).(int) // 1111
}
...
func (this *QFont) SetPixelSize(arg0 int) {
	rv, err := qtrt.Qtcc1(3592007514, "_ZN5QFont12setPixelSizeEi", qtrt.FFITY_POINTER, this.GetCthis(), arg0)
	qtrt.ErrPrint(err, rv)
}
...
func (this *QFont) Weight() int {
	rv, err := qtrt.Qtcc1(1776350790, "_ZNK5QFont6weightEv", qtrt.FFITY_POINTER, this.GetCthis())
	qtrt.ErrPrint(err, rv)
	return qtrt.Cretval2go("int", rv).(int) // 1111
}
...
func (this *QFont) SetWeight(arg0 int) {
	rv, err := qtrt.Qtcc1(133781457, "_ZN5QFont9setWeightEi", qtrt.FFITY_POINTER, this.GetCthis(), arg0)
	qtrt.ErrPrint(err, rv)
}
...
func (this *QFont) Bold() bool {
	rv, err := qtrt.Qtcc1(1200580973, "_ZNK5QFont4boldEv", qtrt.FFITY_POINTER, this.GetCthis())
	qtrt.ErrPrint(err, rv)
	return rv != 0
}
...
func (this *QFont) SetBold(arg0 bool) {
	rv, err := qtrt.Qtcc1(1947504972, "_ZN5QFont7setBoldEb", qtrt.FFITY_POINTER, this.GetCthis(), arg0)
	qtrt.ErrPrint(err, rv)
}
...
func (this *QFont) SetStyle(style int) {
	rv, err := qtrt.Qtcc1(2307513941, "_ZN5QFont8setStyleENS_5StyleE", qtrt.FFITY_POINTER, this.GetCthis(), style)
	qtrt.ErrPrint(err, rv)
}
...
func (this *QFont) Style() int {
	rv, err := qtrt.Qtcc1(2644565881, "_ZNK5QFont5styleEv", qtrt.FFITY_POINTER, this.GetCthis())
	qtrt.ErrPrint(err, rv)
	return int(rv)
}
...
func (this *QFont) Italic() bool {
	rv, err := qtrt.Qtcc1(4214105033, "_ZNK5QFont6italicEv", qtrt.FFITY_POINTER, this.GetCthis())
	qtrt.ErrPrint(err, rv)
	return rv != 0
}
...
func (this *QFont) SetItalic(b bool) {
	rv, err := qtrt.Qtcc1(48585686, "_ZN5QFont9setItalicEb", qtrt.FFITY_POINTER, this.GetCthis(), b)
	qtrt.ErrPrint(err, rv)
}
...
func (this *QFont) Underline() bool {
	rv, err := qtrt.Qtcc1(3473615270, "_ZNK5QFont9underlineEv", qtrt.FFITY_POINTER, this.GetCthis())
	qtrt.ErrPrint(err, rv)
	return rv != 0
}
...
func (this *QFont) SetUnderline(arg0 bool) {
	rv, err := qtrt.Qtcc1(2231558831, "_ZN5QFont12setUnderlineEb", qtrt.FFITY_POINTER, this.GetCthis(), arg0)
	qtrt.ErrPrint(err, rv)
}
...
func (this *QFont) Overline() bool {
	rv, err := qtrt.Qtcc1(2096479559, "_ZNK5QFont8overlineEv", qtrt.FFITY_POINTER, this.GetCthis())
	qtrt.ErrPrint(err, rv)
	return rv != 0
}
...
func (this *QFont) SetOverline(arg0 bool) {
	rv, err := qtrt.Qtcc1(229563217, "_ZN5QFont11setOverlineEb", qtrt.FFITY_POINTER, this.GetCthis(), arg0)
	qtrt.ErrPrint(err, rv)
}
...
func (this *QFont) StrikeOut() bool {
	rv, err := qtrt.Qtcc1(2658375640, "_ZNK5QFont9strikeOutEv", qtrt.FFITY_POINTER, this.GetCthis())
	qtrt.ErrPrint(err, rv)
	return rv != 0
}
...
func (this *QFont) SetStrikeOut(arg0 bool) {
	rv, err := qtrt.Qtcc1(3564788945, "_ZN5QFont12setStrikeOutEb", qtrt.FFITY_POINTER, this.GetCthis(), arg0)
	qtrt.ErrPrint(err, rv)
}
...
func (this *QFont) FixedPitch() bool {
	rv, err := qtrt.Qtcc1(3065387023, "_ZNK5QFont10fixedPitchEv", qtrt.FFITY_POINTER, this.GetCthis())
	qtrt.ErrPrint(err, rv)
	return rv != 0
}
...
func (this *QFont) SetFixedPitch(arg0 bool) {
	rv, err := qtrt.Qtcc1(3328821689, "_ZN5QFont13setFixedPitchEb", qtrt.FFITY_POINTER, this.GetCthis(), arg0)
	qtrt.ErrPrint(err, rv)
}
...
func (this *QFont) Kerning() bool {
	rv, err := qtrt.Qtcc1(3727955333, "_ZNK5QFont7kerningEv", qtrt.FFITY_POINTER, this.GetCthis())
	qtrt.ErrPrint(err, rv)
	return rv != 0
}
...
func (this *QFont) SetKerning(arg0 bool) {
	rv, err := qtrt.Qtcc1(43048096, "_ZN5QFont10setKerningEb", qtrt.FFITY_POINTER, this.GetCthis(), arg0)
	qtrt.ErrPrint(err, rv)
}
...
func (this *QFont) StyleHint() int {
	rv, err := qtrt.Qtcc1(1985110254, "_ZNK5QFont9styleHintEv", qtrt.FFITY_POINTER, this.GetCthis())
	qtrt.ErrPrint(err, rv)
	return int(rv)
}
...
func (this *QFont) StyleStrategy() int {
	rv, err := qtrt.Qtcc1(2409632431, "_ZNK5QFont13styleStrategyEv", qtrt.FFITY_POINTER, this.GetCthis())
	qtrt.ErrPrint(err, rv)
	return int(rv)
}
...
func (this *QFont) SetStyleHint(arg0 int, arg1 int) {
	rv, err := qtrt.Qtcc1(4164244041, "_ZN5QFont12setStyleHintENS_9StyleHintENS_13StyleStrategyE", qtrt.FFITY_POINTER, this.GetCthis(), arg0, arg1)
	qtrt.ErrPrint(err, rv)
}
...
func (this *QFont) SetStyleStrategy(s int) {
	rv, err := qtrt.Qtcc1(3706440996, "_ZN5QFont16setStyleStrategyENS_13StyleStrategyE", qtrt.FFITY_POINTER, this.GetCthis(), s)
	qtrt.ErrPrint(err, rv)
}
...
func (this *QFont) Stretch() int {
	rv, err := qtrt.Qtcc1(1924986953, "_ZNK5QFont7stretchEv", qtrt.FFITY_POINTER, this.GetCthis())
	qtrt.ErrPrint(err, rv)
	return qtrt.Cretval2go("int", rv).(int) // 1111
}
...
func (this *QFont) SetStretch(arg0 int) {
	rv, err := qtrt.Qtcc1(969599204, "_ZN5QFont10setStretchEi", qtrt.FFITY_POINTER, this.GetCthis(), arg0)
	qtrt.ErrPrint(err, rv)
}
...
func (this *QFont) LetterSpacing() float64 {
	rv, err := qtrt.Qtcc1(2641819184, "_ZNK5QFont13letterSpacingEv", qtrt.FFI_TYPE_DOUBLE, this.GetCthis())
	qtrt.ErrPrint(err, rv)
	return qtrt.Cretval2go("float64", rv).(float64) // 1111
}
...
func (this *QFont) LetterSpacingType() int {
	rv, err := qtrt.Qtcc1(2189521662, "_ZNK5QFont17letterSpacingTypeEv", qtrt.FFITY_POINTER, this.GetCthis())
	qtrt.ErrPrint(err, rv)
	return int(rv)
}
...
func (this *QFont) SetLetterSpacing(type_ int, spacing float64) {
	rv, err := qtrt.Qtcc1(4000308159, "_ZN5QFont16setLetterSpacingENS_11SpacingTypeEd", qtrt.FFITY_POINTER, this.GetCthis(), type_, spacing)
	qtrt.ErrPrint(err, rv)
}
...
func (this *QFont) WordSpacing() float64 {
	rv, err := qtrt.Qtcc1(3552615348, "_ZNK5QFont11wordSpacingEv", qtrt.FFI_TYPE_DOUBLE, this.GetCthis())
	qtrt.ErrPrint(err, rv)
	return qtrt.Cretval2go("float64", rv).(float64) // 1111
}
...
func (this *QFont) SetWordSpacing(spacing float64) {
	rv, err := qtrt.Qtcc1(2436393468, "_ZN5QFont14setWordSpacingEd", qtrt.FFITY_POINTER, this.GetCthis(), spacing)
	qtrt.ErrPrint(err, rv)
}
...
func (this *QFont) SetCapitalization(arg0 int) {
	rv, err := qtrt.Qtcc1(2579133516, "_ZN5QFont17setCapitalizationENS_14CapitalizationE", qtrt.FFITY_POINTER, this.GetCthis(), arg0)
	qtrt.ErrPrint(err, rv)
}
...
func (this *QFont) Capitalization() int {
	rv, err := qtrt.Qtcc1(74477930, "_ZNK5QFont14capitalizationEv", qtrt.FFITY_POINTER, this.GetCthis())
	qtrt.ErrPrint(err, rv)
	return int(rv)
}
...
func (this *QFont) SetHintingPreference(hintingPreference int) {
	rv, err := qtrt.Qtcc1(2526211871, "_ZN5QFont20setHintingPreferenceENS_17HintingPreferenceE", qtrt.FFITY_POINTER, this.GetCthis(), hintingPreference)
	qtrt.ErrPrint(err, rv)
}
...
func (this *QFont) HintingPreference() int {
	rv, err := qtrt.Qtcc1(1448856926, "_ZNK5QFont17hintingPreferenceEv", qtrt.FFITY_POINTER, this.GetCthis())
	qtrt.ErrPrint(err, rv)
	return int(rv)
}
...
func (this *QFont) ExactMatch() bool {
	rv, err := qtrt.Qtcc1(2416987156, "_ZNK5QFont10exactMatchEv", qtrt.FFITY_POINTER, this.GetCthis())
	qtrt.ErrPrint(err, rv)
	return rv != 0
}
