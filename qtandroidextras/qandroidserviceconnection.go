...
func (this *QAndroidServiceConnection) OnServiceConnected(name *qtcore.QString, serviceBinder *QAndroidBinder) {
...
func (this *QAndroidServiceConnection) OnServiceDisconnected(name *qtcore.QString) {
	var convArg0 = name.GetCthis()
